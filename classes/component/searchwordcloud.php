...
class SearchWordCloud extends Base
{
    ...
    public function draw($instance = '', $args = array(), $disable_params = false)
    {
        ...
        $color_min=$this->_cp['colour_min'];
        $color_max=$this->_cp['colour_max'];
        foreach ($this->filtered as $word => $count) {
            $this->_html.=
                 "<a href=\""
                .BASE_PATH."search_results/?search_text=".$word
                ...
                ."color:".get_color_for_weight(100*$count/$this->maxMatches, $color_min, $color_max)
                ."\""
                ." title=\"".$word." (".$count.")\">"
                .$word
                ."</a> ";
