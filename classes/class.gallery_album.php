<?php
define('VERSION_GALLERY_ALBUM','1.0.32');
/*
Version History:
  1.0.32 (2013-06-21)
...
class Gallery_Album extends Posting_Container {
  function __construct($ID="",$systemID=SYS_ID) {
    ...
    $this->_set_default_enclosure_base_folder((defined('BASE_PATH') ? BASE_PATH : '/').'UserFiles/Image/gallery-images/');
...
//    y($tmp);
  ...
  public function manage_gallery_images(){
    ...
    $out = "<h3 style='margin:0.25em'>Gallery Images inside this ".$this->_get_object_name().":</h3>";
    if (!get_var('selectID')) {
      $out.="<p style='margin:0.25em'>No contents - this ".$this->_get_object_name()." has not been saved yet.</p>";
    }
    else {
      $out.= draw_auto_report('gallery-images-for-gallery-album',1);
    }
    return $out;
  }
  ...
  public function manage_gallery_albums(){
    ...
    $out = "<h3 style='margin:0.25em'>Gallery Albums inside this ".$this->_get_object_name().":</h3>";
    if (!get_var('selectID')) {
      $out.="<p style='margin:0.25em'>No contents - this ".$this->_get_object_name()." has not been saved yet.</p>";
    }
    else {
      $out.= draw_auto_report('gallery-albums-for-gallery-album',1);
    }
    return $out;
  }
