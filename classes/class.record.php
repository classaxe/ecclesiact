...
class Record extends Portal {
  static $cache_ID_by_name_array =      array();
  static $cache_record_array =          array();
  static $cache_debug_query_checksum =  array();
...
// Current Setter and Getter functions:
  public function _get($property)                   { return $this->$property; }
  public function _get_assign_type()                { return $this->assign_type; }
  public function _get_db_name()                    { return $this->db_name; }
  public function _get_fixed_fields()               { return $this->_fixed_fields_array; }
  public function _get_has_actions()                { return $this->_has_actions; }
  public function _get_has_activity()               { return $this->_has_activity; }
  public function _get_has_archive()                { return $this->_has_archive; }
  public function _get_has_categories()             { return $this->_has_categories;}
  public function _get_has_groups()                 { return $this->_has_groups;}
  public function _get_has_keywords()               { return $this->_has_keywords; }
  public function _get_has_languages()              { return $this->_has_languages; }
  public function _get_has_push_products()          { return $this->_has_push_products; }
  public function _get_ID()                         { return $this->ID; }
  public function _get_listtype()                   { return $this->listtype; }
  public function _get_listTypeID()                 { return $this->listTypeID; }
  public function _get_message_associated()         { return $this->_message_associated; }
  public function _get_name_field()                 { return $this->name_field; }
  public function _get_path_prefix()                { return $this->_path_prefix; }
  public function _get_search_type()                { return $this->_search_type; }
  public function _get_systemID()                   { return $this->systemID; }
  public function _get_table_name()                 { return $this->table; }
  public function _get_type()                       { return ''; }  // overridden by child classes

  public function _set($property,$value)            { $this->$property = $value; }
  public function _set_multiple($args)              { foreach ($args as $key=>$value){ $this->$key = $value; }}
  public function _set_assign_type($value)          { $this->assign_type = $value; }
  public function _set_db_name($value)              { $this->db_name = $value; }
  public function _set_fixed_fields($value)         { $this->_fixed_fields_array = $value; }
  public function _set_has_actions($value)          { $this->_has_actions = $value; }
  public function _set_has_activity($value)         { $this->_has_activity = $value; }
  public function _set_has_archive($value)          { $this->_has_archive = $value; }
  public function _set_has_categories($value)       { $this->_has_categories = $value; }
  public function _set_has_groups($value)           { $this->_has_groups = $value; }
  public function _set_has_keywords($value)         { $this->_has_keywords = $value; }
  public function _set_has_languages($value)        { $this->_has_languages = $value; }
  public function _set_has_push_products($value)    { $this->_has_push_products = $value; }
  public function _set_ID($value)                   { $this->ID = $value; }
  public function _set_listtype($value)             { $this->listtype = $value; }
  public function _set_listTypeID($value)           { $this->listTypeID = $value; }
  public function _set_message_associated($value)   { $this->_message_associated = $value; }
  public function _set_name_field($value)           { $this->name_field = $value; }
  public function _set_path_prefix($value)          { $this->_path_prefix = $value; }
  public function _set_search_type($value)          { $this->_search_type = $value; }
  public function _set_systemID($value)             { $this->systemID = $value; }
  public function _set_table_name($value)           { $this->table = $value; }

  public function _push_fixed_field($key,$value)    { $this->_fixed_fields_array[$key] = $value; }

  function add($data,$validate=false){
    deprecated();
...
//    z($sql);
  ...
  function copy_category_assign($newID,$new_systemID="") {
    if (!$this->_get_has_categories()){
      return;
    }
  ...
  function copy_group_assign($newID,$new_systemID="") {
  ...
  function copy_keyword_assign($newID,$new_systemID="") {
  ...
  function copy_push_product_assign($newID,$new_systemID="") {
  ...
  function count_all_for_system($systemID=SYS_ID) {
    $sql =
       "SELECT\n"
      ."  COUNT(*)\n"
      ."FROM\n"
  ...
  function count_named($name,$systemID="") {
    $sql =
       "SELECT\n"
      ."  count(*) AS `count`\n"
      ."FROM\n"
...
//    z($sql);
  ...
  function decrement($field,$validate=false) {
...
//    z($sql);
  ...
  static public function do_sql_query($sql,$connection=false) {
  ...
  function exists_named($name,$systemID="") {
    return ($this->count_named($name,$systemID) > 0);
  }

  function exists_table_column($test){
  ...
  function get_arrays_for_sql($sql){
    deprecated();
    return $this->get_rows_for_sql($sql);
  }

  function get_category_assign() {
    if ($this->_get_ID()=='') {
      return array();
    }
    $sql =
  ...
  function get_children_by_parentID($ID,$sortBy='',$apply_visibility=false){
...
//    z($sql);
  ...
  function get_children_by_name($name,$sortBy=false,$apply_visibility=false){
    $out = array();
    $ID = $this->get_ID_by_name($name);
    return $this->get_children_by_parentID($ID,$sortBy,$apply_visibility);
  }

  function get_csv_for_sql($sql){
    $out = array();
  ...
  function get_edit_params()        { return $this->_edit_params_array; }
  ...
  function get_field_for_sql($sql) {
  ...
  static function get_embedded_file_properties($value) {
    $out =
      array(
        'name' => '',
        'size' => '',
...
//    z($sql);die;
  ...
  function get_ID_by_name($name,$systemID=false,$no_cache=false) {
    $key = $this->_get_object_name()."_".$systemID."_".$name;
...
//    z($sql);
  ...
  function get_IDs_by_system($systemID) {
    $sql =
       "SELECT\n"
      ."  `ID`\n"
      ."FROM\n"
  ...
  static public function get_last_db_error_msg(){
    global $Obj_MySQLi;
    return $Obj_MySQLi->error;
  }

  static public function get_last_db_error_msg_generic(){
  ...
  static public function get_last_db_error_num(){
    global $Obj_MySQLi;
  ...
  function get_push_product_assign() {
    if ($this->_get_ID()=='') {
      return array();
    }
    $sql =
  ...
  function get_record($Caching=true) {
    if (!$ID = sanitize('ID',$this->_get_ID())){
      return false;
    }
...
//    z($sql);
  ...
  function get_records($systemID='',$sortBy='') {
    $sql =
       "SELECT\n"
      ."  *\n"
      ."FROM\n"
  ...
  function get_records_by_ID($systemID='',$sortBy='') {
    $sql =
       "SELECT\n"
      ."  *\n"
      ."FROM\n"
  ...
  function get_record_by_name($name,$systemID=SYS_ID) {
    $sql =
       "SELECT\n"
      ."  *\n"
      ."FROM\n"
  ...
  function get_records_by_parentID($parentID, $systemID='',$sortBy='') {
    $sql =
       "SELECT\n"
      ."  *\n"
      ."FROM\n"
  ...
  function get_records_for_sql($sql){
    if (!$result = Record::do_sql_query($sql)) {
      do_log(3,__CLASS__.'::'.__FUNCTION__.'()','execute',"Object: ".$this->_get_object_name()."\nQuery: ".$sql."\nError: ".Record::get_last_db_error_msg());
  ...
  function get_records_for_system($systemID,$sortBy=false) {
    $sql =
       "SELECT\n"
      ."  *\n"
      ."FROM\n"
...
//    z($sql);
  ...
  function get_remote_xml_file($url){
    if ($url=="") {
      return "";
    }
//    die($url);
    ...
    if($s->getUrl($url)){
      if(is_array($s->headers)){
        ...
        elseif(preg_match("/xml/i",$h['content-type'])) // got XML back
          ...
          $buffer=$this->get_remote_xml_file_error("The server did not return XML. The content type returned was ".$h['content-type']);
        }
      else {
  ...
  function get_remote_xml_file_error($error){
    $retVal=
       "<?xml version=\"1.0\" ?>\n"
      ."<rss version=\"2.0\">\n"
      ."\t<channel>\n"
  ...
  function get_status_text($message,$args,&$msg,&$msg_tooltip) {
    switch ($message) {
      ...
      case "subject_required":
        switch ($message) {
          case "name_exists_global":
            $attribute = 'a unique '.$this->_get_name_field().($this->_get_name_field()!='value' ? " value" : "")." - <b>".$args['targetValue']."</b> is already in use";
          break;
          case "name_exists_local":
            $attribute = 'a unique '.$this->_get_name_field().($this->_get_name_field()!='value' ? " value" : "")." for this site - <b>".$args['targetValue']."</b> is already in use in this system";
          break;
          case "name_required":
            $attribute = 'a name';
          break;
      ...
      case "copied":
        $targetID =     (isset($args['targetID']) ? $args['targetID'] : "");
        $targetValue =  (isset($args['targetValue']) ? $args['targetValue'] : "");
        $msg =          status_message(0,true,$this->_get_object_name().$this->plural(1),'','been copied'.($targetValue ? " to $targetValue" : "").'.',$targetID);
        $msg_tooltip =  status_message(0,false,$this->_get_object_name().$this->plural(1),'','been copied'.($targetValue ? " to $targetValue" : "").'.',$args['targetID']);
      break;
    }
  }
  ...
  function get_xml_for_sql($sql,$enc='UTF-8'){
    $records = $this->get_records_for_sql($sql);
    $fields_arr = array();
    if ($records===false) {
      return $sql;
...
//          ."]]>"
  ...
  function get_YYYYMMDD_to_format($YYYYMMDD,$format="MMM DD, YYYY") {
    $date =
      adodb_mktime(
  ...
  function group_assign($csv_list='') {
    if (!$this->_get_has_groups()){
      return;
    }
    $systemID = $this->get_field('systemID');
  ...
  function increment($field,$validate=false) {
    $value = $this->get_field($field);
    if (!is_numeric($value)) {
      return false;
    }
  ...
  function insert($data,$validate=false){
    if (!is_array($data)) {
      do_log(3,__CLASS__.'::'.__FUNCTION__.'()','validate',"Object: ".$this->_get_object_name()."\nData not an Array");
  ...
  function is_visible($record) {
    ...
    $isMember =         ($isMASTERADMIN || $isUSERADMIN || $isCOMMUNITYADMIN || $isSYSADMIN || $isSYSAPPROVER || $isSYSEDITOR || $isSYSMEMBER);
  ...
  function is_visible_to_groups($record_csv,$group_csv) {
  ...
  function load($data=false, $caching=false){
    if ($data!==false) {
      $this->record = $data;
    }
    else {
  ...
  function manage_actions($report_name) {
    ...
    if (!$selectID = get_var('selectID')) {
      return
        ...
        ."<p style='margin:0.25em'>No Actions - this ".$this->_get_object_name()." has not been saved yet.</p>";
    }
    $this->_set_ID($selectID);
    if (!$this->exists()){
      return
         "<h3 style='margin:0.25em'>Actions for ".$this->_get_object_name()."</h3>"
        ."<p style='margin:0.25em'>No Actions - this ".$this->_get_object_name()." appears to have been deleted.</p>";
    }
    return
  ...
  function matched($data,$validate=false) {
    $sql_checks = array();
    if ($validate){
      $classname = get_class($this);
  ...
  function on_action_set_map_location(){
  ...
  function push_product_unassign(){
    if (!$this->_get_has_push_products()){
      return;
    }
    $Obj = new Push_Product_Assign;
  ...
  function _set_edit_param($param, $value){
    $this->_edit_params_array[$param]=$value;
  }

  function set_edit_params($value){
    $this->_edit_params_array =
      array(
        'command_for_delete' =>     (isset($value['command_for_delete']) ?      $value['command_for_delete'] :      ''),
        'report' =>                 (isset($value['report']) ?                  $value['report'] :                  ''),
        'report_related_products' =>(isset($value['report_related_products']) ? $value['report_related_products'] : false),
        'report_rename' =>          (isset($value['report_rename']) ?           $value['report_rename'] :           false),
        'report_rename_label' =>    (isset($value['report_rename_label']) ?     $value['report_rename_label'] :     ''),
        'icon_delete' =>            (isset($value['icon_delete']) ?             $value['icon_delete'] :             ''),
        'icon_edit' =>              (isset($value['icon_edit']) ?               $value['icon_edit'] :               ''),
        'icon_edit_disabled' =>     (isset($value['icon_edit_disabled']) ?      $value['icon_edit_disabled'] :      ''),
        'icon_edit_popup' =>        (isset($value['icon_edit_popup']) ?         $value['icon_edit_popup'] :         '')
      );
  }

  function set_field_date_add($field,$YYYY,$MM,$DD){
  ...
  function set_field($field,$value,$validate=true,$reveal_modification=true) {
//    print "\$field=$field,\$value=$value,\$validate=$validate<br />";
    $data = array($field=>$value);
    return $this->update($data,$validate,$reveal_modification);
  }

  function set_field_for_all($field,$value) {
    $sql =
       "UPDATE\n"
      ."  `".$this->_get_db_name()."`.`".$this->_get_table_name()."`\n"
      ."SET\n"
  ...
  function set_field_on_value($field,$old_value_csv,$new_value) {
    $sql =
       "UPDATE\n"
      ."  `".$this->_get_db_name()."`.`".$this->_get_table_name()."`\n"
      ."SET\n"
  ...
  function set_ID_by_name($name,$systemID=false,$no_cache=false){ $this->_set_ID($this->get_ID_by_name($name,$systemID,$no_cache)); }

  function set_plural_append($one,$many) { $this->_plural_append_array = array($one,$many); }

  function sort_records($array,$fieldsort_arr) {
    $this->field_arr = $fieldsort_arr;
    usort( $array, array($this,'sort_records_function'));
    return $array;
  }

  function sort_records_function( $a, $b ){
  ...
  function sql_export($targetID,$show_fields,$header="",$orderBy="",$extra_delete="",$extra_select="") {
  ...
  function sql_export_delete($targetID,$show_fields,$header="",$orderBy="",$extra_delete="",$extra_select="") {
    global $db;
    if ($header=="") {
      $header = "Selected ".$this->_get_object_name().$this->plural($targetID);
    }
    $table = ($this->_get_db_name()==$db ? $this->_get_table_name() : $this->_get_db_name()."`.`".$this->_get_table_name());
    $table = pad("`".$table."`",24);
    return
      $this->sql_header($header)
     .($extra_delete!="" ? trim($extra_delete,"\n")."\n" : "")
     .($this->_get_has_actions() ?     "DELETE FROM `action`                 WHERE `sourceType`  = '".$this->_get_assign_type()."' AND `sourceID` IN (".$targetID.");\n" : "")
     .($this->_get_has_activity() ?    "DELETE FROM `activity`               WHERE `sourceType`  = '".$this->_get_assign_type()."' AND `sourceID` IN (".$targetID.");\n" : "")
     .($this->_get_has_categories() ?  "DELETE FROM `category_assign`        WHERE `assign_type` = '".$this->_get_assign_type()."' AND `assignID` IN (".$targetID.");\n" : "")
     .($this->_get_has_groups() ?      "DELETE FROM `group_assign`           WHERE `assign_type` = '".$this->_get_assign_type()."' AND `assignID` IN (".$targetID.");\n" : "")
     .($this->_get_has_keywords() ?    "DELETE FROM `keyword_assign`         WHERE `assign_type` = '".$this->_get_assign_type()."' AND `assignID` IN (".$targetID.");\n" : "")
     .($this->_get_has_languages() ?   "DELETE FROM `language_assign`        WHERE `assign_type` = '".$this->_get_assign_type()."' AND `assignID` IN (".$targetID.");\n" : "")
     .                                 "DELETE FROM ".pad($table,25).       "WHERE ".($this->_get_listTypeID() ? "`listTypeID` = ".$this->_get_listTypeID()." AND " : "")."`ID` IN ($targetID);\n"
      ;
  }

  function sql_export_select($targetID,$show_fields,$header="",$orderBy="",$extra_delete="",$extra_select="") {
    global $db;
    $table = ($this->_get_db_name()==$db ? $this->_get_table_name() : $this->_get_db_name()."`.`".$this->_get_table_name());
    $table = pad("`".$table."`",24);
    ...
    return
      $this->sql_footer()
     .$Obj->db_export_sql_query($table,"SELECT * FROM ".$table." WHERE ".($this->_get_listTypeID() ? "`listTypeID` = ".$this->_get_listTypeID()." AND " : "")."`ID` IN ($targetID)$orderBy",$show_fields)
     .($this->_get_has_actions() ?           $Obj->db_export_sql_query("`action`                ","SELECT * FROM `action`  WHERE `sourceType` = '".$this->_get_assign_type()."' AND `sourceID` IN (".$targetID.") ORDER BY `seq`",$show_fields) : "")
     .($this->_get_has_activity() ?          $Obj->db_export_sql_query("`activity`              ","SELECT * FROM `activity`  WHERE `sourceType` = '".$this->_get_assign_type()."' AND `sourceID` IN (".$targetID.") ORDER BY `history_created_date`",$show_fields) : "")
     .($this->_get_has_categories()!='' ?    $Obj->db_export_sql_query("`category_assign`       ","SELECT * FROM `category_assign`  WHERE `assign_type` = '".$this->_get_assign_type()."' AND `assignID` IN(".$targetID.");",$show_fields) : "")
     .($this->_get_has_groups()!='' ?        $Obj->db_export_sql_query("`group_assign`          ","SELECT * FROM `group_assign`  WHERE `assign_type` = '".$this->_get_assign_type()."' AND `assignID` IN(".$targetID.");",$show_fields) : "")
     .($this->_get_has_keywords() ?          $Obj->db_export_sql_query("`keyword_assign`        ","SELECT * FROM `keyword_assign`  WHERE `assign_type` = '".$this->_get_assign_type()."' AND `assignID` IN (".$targetID.")",$show_fields) : "")
     .($this->_get_has_languages() ?         $Obj->db_export_sql_query("`language_assign`       ","SELECT * FROM `language_assign`  WHERE `assign_type` = '".$this->_get_assign_type()."' AND `assignID` IN (".$targetID.")",$show_fields) : "")
     .($extra_select!="" ? "$extra_select" : "")
     ."\n";
  }

  function sql_header($text) {
  ...
  function try_copy(&$newID,&$msg,&$msg_tooltip,$name=false,$global=false){
    ...
    if ($newID) {
      ...
      $msg =         status_message(0,true,$this->_get_object_name().$singular,$this->_get_message_associated(),($name ? "been copied to ".$name : "been duplicated."),$this->_get_ID());
      $msg_tooltip = status_message(0,false,$this->_get_object_name().$singular,$this->_get_message_associated(),($name ? "been copied to ".$name : "been duplicated."),$this->_get_ID());
      return true;
    }
    return false;
  }

  function try_delete(&$msg){
    $this->delete();
    $msg = status_message(0,true,$this->_get_object_name(),$this->_get_message_associated(),'been deleted.',$this->_get_ID());
    return true;
  }
  ...
  function update($data,$validate=false,$reveal_modification=true){
  // Note: reverts to insert() if ID not set
    ...
    if (substr($this->_get_table_name(),0,4)=='cus_'  && $reveal_modification) {
      ...
      if (!array_key_exists('history_modified_IP',$data) && isset($_SERVER['REMOTE_ADDR']) && $reveal_modification) {
        $data['history_modified_IP'] = $_SERVER['REMOTE_ADDR'];
      }
    }
    $hasXML = false;
...
//      z($sql); die;
  ...
  function xmlfields_encode(&$row) {
    ...
    foreach ($xml_keys as $key) {
      ...
      foreach ($pathBits as $bit) {
        if (strlen($bit) > 0) { // in case of double slashes?
    ...
    $row['XML_data'] = str_replace("<?xml version=\"1.0\" encoding=\"iso-8859-1\"?>","<?xml version='1.0' encoding='iso-8859-1'?>",$row['XML_data']);
  }

  function xmlfields_decode(&$row) {
    // By James Fraser
    // takes an array of fieldname => fieldvalue pairs,
  ...
  function xmlfields_decodeRecursive($el, $key = 'xml:') {
    // By James Fraser
    $delimiter = ':';
    $pairs = array();
