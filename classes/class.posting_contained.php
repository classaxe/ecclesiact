<?php
define ("VERSION_POSTING_CONTAINED","1.0.24");
/*
Version History:
  1.0.241 (2013-12-18)
    ...
    switch (get_var('submode')) {
      ...
      case "podcast_album_delete":
        ...
        if ($Obj_parent->get_field('systemID')==SYS_ID) {
          $Obj_parent->delete();
          return "<b>Success:</b> ".str_replace('_',' ',$this->_get_container_object_type())." was deleted.";
        }
      break;
      case "gallery_image_cover":
        ...
        if ($this->load() && $this->record['systemID']==SYS_ID) {
          ...
          return "<b>Success:</b> ".$this->_get_object_name()." now featured on ".str_replace('_',' ',$this->_get_container_object_type()).".";
        }
      break;
      case "gallery_image_delete":
        ...
        if ($this->get_field('systemID')==SYS_ID) {
          $this->delete();
          return "<b>Success:</b> ".$this->_get_object_name()." was deleted.";
        }
      break;
      case "gallery_image_rotate_left":
        ...
        if ($this->load() && $this->record['systemID']==SYS_ID) {
          if (!$filename = Image_Factory::rotate($this->record['thumbnail_small'],$degrees)){
            return "<b>Error:</b> ".$this->_get_object_name()." '<b>".$this->record['title']."</b>' is of incorrect file type.";
          }
          $cs = FileSystem::get_file_checksum($filename);
          $this->set_field('thumbnail_cs_small',$cs);
          return "<b>Success:</b> ".$this->_get_object_name()." '<b>".$this->record['title']."</b>' was rotated left.";
        }
      break;
      case "gallery_image_rotate_right":
        ...
        if ($this->load() && $this->record['systemID']==SYS_ID) {
          ...
          $cs = FileSystem::get_file_checksum($filename);
          $this->set_field('thumbnail_cs_small',$cs);
          return "<b>Success:</b> ".$this->_get_object_name()." '<b>".$this->record['title']."</b>' was rotated right.";
        }
      break;
