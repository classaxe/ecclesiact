<?php
define('VERSION_PODCAST_ALBUM','1.0.16');
/*
Version History:
  1.0.16 (2013-06-07)
...
class Podcast_Album extends Posting_Container {
  function __construct($ID="",$systemID=SYS_ID) {
    ...
    $this->set_edit_params(
      array(
        'report' =>                 'podcast-albums',
        'report_rename' =>          true,
        'report_rename_label' =>    'new title',
        'icon_delete' =>            '[ICON]18 18 5340 Delete this '.$this->_get_object_name().'[/ICON]',
        'icon_edit' =>              '[ICON]19 19 5302 Edit this '.$this->_get_object_name().'[/ICON]',
        'icon_edit_disabled' =>     '[ICON]19 19 5321 (Edit this '.$this->_get_object_name().')[/ICON]',
        'icon_edit_popup' =>        '[ICON]19 19 4750 Edit this '.$this->_get_object_name().' in a popup window[/ICON]'
      )
    );
    $this->_cp_vars_detail = array(
      'audioplayer_height' =>       array('match' => 'range|0,n',       'default' => '48',              'hint' => '0|x'),
      'audioplayer_width' =>        array('match' => 'range|0,n',       'default' => '280',             'hint' => '0|x'),
      'author_show' =>              array('match' => 'enum|0,1',        'default' => '1',               'hint' => 'Whether or not to show author name'),
      'block_layout' =>             array('match' => '',                'default' => 'Podcast Album',   'hint' => 'Name of Block Layout to use'),
      'contents_block_layout' =>    array('match' => '',                'default' => 'Podcast',         'hint' => 'Name of Block Layout to use for content listings'),
    ...
    $this->_cp_vars_listings = array(
      ...
      'box_title' =>                array('match' => '',                'default' => 'Podcast Albums',  'hint' => 'text'),
      'box_title_link' =>           array('match' => 'enum|0,1',        'default' => '0',               'hint' => '0|1'),
      'box_title_link_page' =>      array('match' => '',                'default' => 'podcast-albums',  'hint' => 'page'),
  ...
  protected function BL_contained_items(){
    ...
    $args = array(
      ...
      'filter_limit' =>             $this->_cp['contents_results_limit'],
      'filter_container_path' =>    $this->record['path'],
      'paging_controls' =>          $this->_cp['contents_results_paging']
    );
  ...
  public function manage_podcasts(){
    ...
    $out = "<h3 style='margin:0.25em'>Podcasts inside this ".$this->_get_object_name().":</h3>";
    if (!get_var('selectID')) {
      $out.="<p style='margin:0.25em'>No contents - this ".$this->_get_object_name()." has not been saved yet.</p>";
    }
    else {
      $out.= draw_auto_report('podcasts-for-podcast-album',1);
    }
    return $out;
  }
  ...
  public function manage_podcast_albums(){
    ...
    $out = "<h3 style='margin:0.25em'>Podcast Albums inside this ".$this->_get_object_name().":</h3>";
    if (!get_var('selectID')) {
      $out.="<p style='margin:0.25em'>No contents - this ".$this->_get_object_name()." has not been saved yet.</p>";
    }
    else {
      $out.= draw_auto_report('podcast-albums-for-podcast-album',1);
    }
    return $out;
  }
