<?php
define ("VERSION_COMPONENT_GALLERY_THUMBNAILS","1.0.34");
/*
Version History:
  1.0.34 (2014-01-28)
...
class Component_Gallery_Thumbnails extends Component_Base {
  ...
  public function __construct(){
    ...
    $this->_parameter_spec =    array(
      'caption_height' =>           array('match' => 'range|0,n',       'default' =>'55',           'hint'=>'Height of caption in pixels (if shown)'),
      'color_background' =>         array('match' => 'hex3|',           'default' =>'ffffff',       'hint'=>'Hex code for background colour for each image block with title and caption, if shown'),
      'color_border' =>             array('match' => 'hex3|',           'default' =>'c0c0c0',       'hint'=>'Hex code for colour to use for border if shown'),
      'color_image_border' =>       array('match' => 'hex3|',           'default' =>'c0c0c0',       'hint'=>'Hex code for colour to use for image border if shown'),
      'color_image_border_over' =>  array('match' => 'hex3|',           'default' =>'4040ff',       'hint'=>'Hex code for colour to use for image border on mouse over if shown'),
      ...
      'image_padding_horizontal' => array('match' => 'range|0,n',       'default' =>'0',            'hint'=>'Space to pad around images horizontally'),
      'image_padding_vertical' =>   array('match' => 'range|0,n',       'default' =>'0',            'hint'=>'Space to pad around images vertically'),
      'image_spacing_horizontal' => array('match' => 'range|0,n',       'default' =>'10',           'hint'=>'Space to leave between images horizontally'),
      'image_spacing_vertical' =>   array('match' => 'range|0,n',       'default' =>'10',           'hint'=>'Space to leave between images vertically'),
      ...
      'show_background' =>          array('match' => 'enum|0,1',        'default' =>'0',            'hint'=>'0|1'),
      'show_border' =>              array('match' => 'enum|0,1',        'default' =>'0',            'hint'=>'0|1 - places border around block containing title, image and caption '),
      'show_image' =>               array('match' => 'enum|0,1',        'default' =>'1',            'hint'=>'0|1 - remember a title and / or caption may still be shown'),
      'show_image_border' =>        array('match' => 'enum|0,1',        'default' =>'0',            'hint'=>'0|1 - places border around image'),
      'show_caption' =>             array('match' => 'enum|0,1',        'default' =>'0',            'hint'=>'0|1 - if shown admins can edit simply by clicking the content'),
      'show_links' =>               array('match' => 'enum|0,1',        'default' =>'1',            'hint'=>'If any images have links, activate them'),
      'show_title' =>               array('match' => 'enum|0,1',        'default' =>'0',            'hint'=>'0|1 - if shown admins can edit simply by clicking the title'),
      'show_tooltip' =>             array('match' => 'enum|0,1',        'default' =>'0',            'hint'=>'0|1 - places Title for image as a tooltip'),
      'show_uploader' =>            array('match' => 'enum|0,1',        'default' =>'1',            'hint'=>'Show uploader control for administrators'),
      'title_height' =>             array('match' => 'range|0,n',       'default' =>'35',           'hint'=>'Height of title in pixels (if shown)'),
    );
  }
...
//    y($this->_cp);die;
  ...
  protected function _draw_css(){
    ...
    $this->_css.=
      ...
      ."  width:". ($width) ."px;"
      ." height:"
      .(($this->_cp['show_image'] ? $height : 0)+ ($this->_cp['show_title'] ? 35 : 0)+($this->_cp['show_caption'] ? 55 : 0))."px;\n"
      .($this->_cp['show_background'] ? "  background-color: #".trim($this->_cp['color_background'],'#').";\n" : "")
      .($this->_cp['show_border'] ?     "  border: 1px solid #".trim($this->_cp['color_border'],'#').";\n" : "")
      ."}\n"
  ...
  protected function _draw_image_centered($image){
    ...
    return
      ...
      .($this->_cp['show_title'] ?
         ...
         .($this->_isAdmin ? " onclick=\"gallery_image_edit_click(this,'".$this->_safe_ID."_params','".$this->_cp['title_height']."','".$this->_cp['caption_height']."')\"" : "")
         .">\n"
  ...
  protected function _draw_js(){
    ...
    $js.=
      ...
      ."  url :    '".BASE_PATH.trim($page_vars['path_real'],'/').'/'.trim($page_vars['path_extension'],'/')."',\n"
