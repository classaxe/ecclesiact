...
class Help extends Base
{
    ...
    public static function frameset()
    {
        ...
        print
            ...
            ."  <frameset rows=\"27,*\">\n"
            ."    <frame src=\"".BASE_PATH."?mode=help&amp;submode=navbar\" name=\"navigation\" scrolling=\"no\""
    ...
    public static function functions_js()
    {
    ...
    public static function menu()
    {
        ...
        print
            ...
            .".icons { border: 0; display: block; float: left; background-image:url(".BASE_PATH."img/sysimg/icons.gif/"
            .System::get_item_version('icons')
            .");}\r\n"
            ."</style>\n"
            ."<script type='text/javascript' src=\"".BASE_PATH."sysjs/treeview/"
            .System::get_item_version('js_treeview')
            ."\"></script>\n"
    ...
    public static function menu_js()
    {
        $Obj = new Link;
    ...
    public static function navbar()
    {
        ...
        print
            ...
            ."<a href=\"#\" onclick=\"nav_go('up');return false;\""
            ." onmouseout=\"return nav_out('up')\""
            ." onmouseover=\"return nav_over('up')\">"
            ."<img src='".BASE_PATH."img/sysimg/icon_help_up_n.gif' id='up' alt='Previous Level' width='26' />"
            ."</a>"
            ."<a href=\"#\" onclick=\"nav_go('back');return false;\""
            ." onmouseout=\"return nav_out('back')\""
            ." onmouseover=\"return nav_over('back')\">"
            ."<img src='".BASE_PATH."img/sysimg/icon_help_previous_n.gif' id='back'"
            ." title='Previous Topic' alt='Previous Topic' width='20' />"
            ."</a>"
            ."<a href=\"#\" onclick=\"nav_go('next');return false;\""
            ." onmouseout=\"return nav_out('next')\""
            ." onmouseover=\"return nav_over('next')\">"
            ."<img src='".BASE_PATH."img/sysimg/icon_help_next_n.gif' id='next' alt='Next Topic' width='20' />"
            ."</a>"
            ."<img src='".BASE_PATH."img/sysimg/icon_help_separator.gif' alt='|' width='12' />"
            ."<a href=\"#\" onclick=\"print_topic();return false;\""
            ." onmouseout=\"return nav_out('print')\""
            ." onmouseover=\"return nav_over('print')\">"
            ."<img src='".BASE_PATH."img/sysimg/icon_help_print_n.gif' id='print' alt='Print this Topic' width='27' />"
            ."</a>"
            ."</div>\n"
            ."</body>\n"
            ."</html>";
