        ...
        switch ($type) {
            ...
            case "bool":
                if ($readOnly) {
                    ...
                    .($value=="1" ?
                        ...
                        ." style='height:13px;width:13px;background-position: -2222px 0px;' />"
                    :
                         "<img src=\"".BASE_PATH."img/spacer\" alt='No' title='No' class='icons'"
                        ." style='height:13px;width:13px;background-position: -2235px 0px;' />"
                    )
                    ."</td>\n";
                } else {
                    $out.=
                        ...
                        "<a onmouseover=\"window.status='Set to NO'; return true;\" "
                         ...
                         ."href=\"#\" onclick=\""
                         ."geid_set('submode','set');"
                         ."geid_set('targetReportID','".$targetReportID."');"
                         ."geid_set('targetFieldID','".$column['ID']."');"
                         ."geid_set('targetID','".$targetID."');"
                         ."geid_set('targetValue','0');"
                         ."geid_set('anchor','row_".$row['ID']."');"
                         .$js_submit.";return false;\">"
                         ."<img class='icons' src='".BASE_PATH."img/spacer' alt=\"Yes - Click for No\""
                         ." title=\"Yes - Click for No\""
                         ." style='height:13px;width:13px;background-position: -2196px 0px;' /></a>"
                        :
                        "<a onmouseover=\"window.status='Set to YES'; return true;\" "
                         ...
                         ."geid_set('targetFieldID','".$column['ID']."');"
                         ."geid_set('targetID','".$targetID."');"
                         ."geid_set('targetValue','1');"
                         ."geid_set('anchor','row_".$row['ID']."');"
                         .$js_submit.";return false;\">"
                         ."<img class='icons' src='".BASE_PATH."img/spacer' alt=\"No - Click for Yes\""
                         ." title=\"No - Click for Yes\""
                         ." style='height:13px;width:13px;background-position: -2209px 0px;' /></a>"
                        )
                        ."</td>\n";
                }
                break;
            case "bool_read":
                $out.=
                     "    <td>"
                    .($value=="1" ?
                         "<img class='icons' src='".BASE_PATH."img/spacer' alt='Yes' title='Yes'"
                        ." style='height:13px;width:13px;background-position: -2222px 0px;' />"
                    :
                         "<img class='icons' src='".BASE_PATH."img/spacer' alt='No' title='No'"
                        ." style='height:13px;width:13px;background-position: -2235px 0px;' />"
                    )
                    ."</td>\n";
                break;
            case "cancel":
                if ($report_name=='my_registered_events' || $page=='your_registered_events' || $page=='register') {
                    ...
                    if (time() > mktime(23, 59, 59, $_MM, $_DD, $_YYYY)) {
                        $out.=
                             "    <td>"
                            ."<a title=\"Cannot cancel - event has already passed.\""
                            ." href=\"#\" onclick=\"alert("
                            ...
                            ."<span style='color:#808080;'><i>Past</i></span>"
                            ."</a></td>\n";
                    } else {
                        if (
                            time() > mktime(
                                ...
                                59,
                                $_MM,
                                $_DD-(int)$system_vars['system_cancellation_days'],
                                $_YYYY
                            )
                        ) {
                            $out.=
                                 "    <td>"
                                ."<a title=\"Cannot cancel - ".$system_vars['system_cancellation_days']
                                ." days notice required.\" href=\"#\" onclick=\""
                            ...
                            $out.=
                                ...
                                ." onclick=\"if(confirm('Cancel this registation?'))"
                                ."{"
                                ."geid_set('targetFieldID','".$column['ID']."');"
                                ."geid_set('targetID','".$value."');"
                                ."geid_set('targetReportID','".$targetReportID."');"
            ...
            case 'checkbox':
                if ($readOnly) {
                    ...
                    $out.=
                        "<td><input type=\"checkbox\" id=\"row_select_".$column['reportID']."_".$value."\""
                       ." name=\"row_select_".$column['reportID']."_$value\" value='1'"
                       ." onclick=\"selected_operation_enable(".$column['reportID'].")\"/></td>";
                }
                break;
            case "copy":
                ...
                $out.=
                    ...
                    ."geid_set('targetFieldID','".$column['ID']."');"
                    ."geid_set('anchor','row_".$row['ID']."');"
                    ."geid_set('submode','copy');"
                    ."geid_set('targetID','".$targetID."');"
                    ."geid_set('targetReportID','".$targetReportID."');"
                    .$js_submit.";return false;"
                    ."}\">"
                    ."<img src='".BASE_PATH."img/spacer' class='icons'"
                    ." style='height:16px;width:14px;background-position:-893px 0px;'"
                    ." title='".$msg."' alt='".$msg."' />"
                    ."</a></td>\n";
                break;
            case "currency":
            ...
            case "datetime":
                $out.=
                    "    <td title='Format: YYYY-MM-DD hh:mm:ss' class='admin_fixed nowrap'>"
            ...
            case "delete":
                if ($readOnly) {
                    ...
                    switch ($this_report_name){
                        case "groups":
                            $out.=
                                 "     <td><a title=\"Delete group and all members?\" href=\"#\""
                                ." onclick=\"if (confirm('Delete group - are you sure?'))"
                                ."{"
                                ."geid_set('targetFieldID','".$column['ID']."');"
                                ."geid_set('targetID','".$value."');"
                                ."geid_set('targetFieldID','".$column['ID']."');"
                                ...
                                ."};return false;\">"
                                ."<img src='".BASE_PATH."img/spacer' class='icons'"
                                ." style='height:10px;width:10px;background-position:-907px 0px;' alt='Delete' />"
                                ."</a></td>\n";
                            break;
                        default:
                            $out.=
                                 "    <td><a title=\"Delete record?\" href=\"#\""
                                ." onclick=\"if (confirm('Delete record - are you sure?'))"
                                ."{"
                                ."geid_set('targetFieldID','".$column['ID']."');"
                                ."geid_set('targetID','".$value."');"
                                ."geid_set('targetFieldID','".$column['ID']."');"
            ...
            case "download_media":
                $out.=
                     "    <td><a title=\"Download this file...\""
                    ." href=\"./?command=download_media&amp;targetID=".$row['ID']."\">"
                    .$value
                    ."</a></td>\n";
                break;
            case "edit":
            case "edit_value_readonly":
                if ($readOnly) {
                    ...
                    $out.=
                         "    <td><a title=\"Edit this record\" href=\"#\""
                        ." onclick=\"details('".$column['name']."',".$row['ID'].","
                        .$popupFormHeight.",".$popupFormWidth.",'',".($selectID!="" ? $selectID : "''")
                        .");return false;\">"
                        .($value!="" ? str_replace('& ', '&amp; ', $value) : "<i>[Edit]</i>")
                        ."</a></td>\n";
                }
                break;
            case "edit_list_data":
                if ($readOnly) {
                    $out.=
                        "    <td>"
                       .($value!="" ? str_replace('& ', '&amp; ', $value) : "<i>[Cannot Edit]</i>")
                       ."</td>\n";
                } else {
                    $out.=
                         "    <td><a title=\"Edit items for this List Type\" rel=\"external\""
                        ." href=\"".BASE_PATH."report/listdata_for_listtype?print=2&amp;selectID=".$row['ID']."\">"
                        .str_replace('& ', '&amp; ', $value)
                        ."</a></td>\n";
                }
                break;
                ...
                if ($readOnly) {
                    ...
                    $out.=
                        ...
                        .(isset($row[$field]) && $row[$field] ?
                             "<a title=\"Click to edit this person\" href='#' onclick='details(\"".$row['type']."\",\""
                            .$row[$field]."\",".$popup['h'].",".$popup['w'].");return false;'>"
                            .($value!=='' ? str_replace('& ', '&amp; ', $value) : '(Blank)')
                            ."</a>"
                        :
                             "<span style='color: #808080' title='This record was deleted'>"
                            .str_replace('& ', '&amp; ', $value)
                            ."</span>"
                        )
                        ."</td>\n";
            ...
            case "email":
                $out.=
                     "    <td valign='top'>"
                    .($value!='' ? "<a href=\"mailto:".$value."\" title='Click to send an email'>"
                    .str_replace('& ', '&amp; ', $value)."</a>" : "&nbsp;")
                    ."</td>\n";
                break;
            case "fieldset_map_loc_lat_lon":
                ...
                $_lon =     $params[3];
                $_area =    $params[4];
                $link_txt = str_replace('& ', '&amp; ', $value!=='' ? $value : '<i>Show</i>');
            ...
            case "file_upload":
                if ($value!='') {
                    ...
                    $out =
                        ...
                        ." (".$file_params['type'].", ".$file_params['size']." bytes)\">Download</a></td>\n";
                } else {
                    $out = "    <td>&nbsp</td>\n";
                }
                break;
            ...
            case "groups_assign_person":
                $out.=
                     "    <td>"
                    ."<a href=\"./?mode=report&amp;report_name=person_groups&amp;print=2&amp;selectID=".$row['ID']."\""
                    ." rel='external' title='Click to edit groups for this person'>"
                    .str_replace('& ', '&amp; ', $value)
                    ."</a></td>\n";
                break;
            case "hh:mm":
            ...
            case "image":
                $out.=
                    ...
                    .($value=="" ?
                        "&nbsp;"
                     :
                        "<a href=\"$value\" title=\"Click to view image\" rel='external'>Image</a>"
                    )
                    ."</td>\n";
                break;
            case "importance":
                if ($readOnly) {
                    $out.=
                        ...
                        .($value=="1" ?
                             "<img src=\"".BASE_PATH."img/spacer\" alt='Yes' title='Yes' class='icons'"
                            ." style='height:13px;width:13px;background-position: -5220px 0px;' />"
                        :
                             "<img src=\"".BASE_PATH."img/spacer\" alt='No' title='No' class='icons'"
                            ." style='height:13px;width:13px;background-position: -5233px 0px;' />"
                        )
                        ."</td>\n";
                } else {
                    $out.=
                     "    <td>"
                    .($value=="1" ?
                         "<a title=\"Set to NO\" href=\"#\" onclick=\""
                        ."geid_set('submode','set');"
                        ."geid_set('targetReportID','".$targetReportID."');"
                        ."geid_set('targetFieldID','".$column['ID']."');"
                        ."geid_set('targetID','".$targetID."');"
                        ...
                        ."<img class='icons' src='".BASE_PATH."img/spacer' alt=\"Yes - Click for No\""
                        ." title=\"Yes - Click for No\""
                        ." style='height:13px;width:13px;background-position: -5220px 0px;' /></a>"
                    :
                    "<a title=\"Set to YES\" href=\"#\" onclick=\""
                     ."geid_set('submode','set');"
                     ."geid_set('targetReportID','".$targetReportID."');"
                     ."geid_set('targetFieldID','".$column['ID']."');"
                     ."geid_set('targetID','".$targetID."');"
                     ...
                     ."<img class='icons' src='".BASE_PATH."img/spacer' alt=\"No - Click for Yes\""
                     ." title=\"No - Click for Yes\""
                     ." style='height:13px;width:13px;background-position: -5233px 0px;' /></a>"
                    )
                    ."</td>\n";
                }
                break;
      ...
      //            print_r($column); die;
            ...
            case "password_set":
                if ($readOnly) {
                    ...
                    $out.=
                         "    <td><a title=\"Set password for user\" href=\"#\" onclick=\""
                        ."popup_password_change('".$column['ID']."','".$targetReportID."','$targetID');"
                        ."return false;\">"
                        ."<img src='".BASE_PATH."img/spacer' class='icons'"
                        ." style='height:15px;width:30px;background-position:-2873px 0px;'"
                        ." alt='Set password for this user' />"
                        ."</a></td>\n";
                }
                break;
            case "percent":
            ...
            case "select_yyyy_mm":
                ...
                $out.=
                    ...
                    ." href='#' onclick='"
                    ."select_YYYY_MM(\"".$row['YYYY']."\",\"".$row['MM']."\",\"".$targetReportName."\");return false;'"
            ...
            case "swatch":
                ...
                $out.=
                     "    <td>"
                    .($value!="" ?
                         "<img src=\"".BASE_PATH."img/color/".$value."\""
                        ." style='margin-top:1px;border: 2px solid #c0c0c0;height:12px;width:16px;display:block;'"
                        ." alt=\"#".$value."\" title=\"#".$value."\" />"
                     :
                         "<img src=\"".BASE_PATH."img/spacer\" class='icons'"
                        ." style='margin-top:1px;border:2px solid #c0c0c0;height:12px;width:16px;"
                        ."background-position:-2903px 0px;display:block;'"
                        ." alt='Value not given'  title='Value not given' />"
                    )
                    ."</td>\n";
                break;
            case "sysurl":
                $out.=
                    "    <td><a href='".$row['systemURL']."' title=\"Click to visit this system\" rel='external'>"
                   .str_replace('& ', '&amp; ', $value)
                   ."</a></td>\n";
                break;
            case "textarea":
            ...
            case "toggle_shared":
                if ($readOnly) {
                    $out.=
                        ...
                        .($value=="1" ?
                             "<img src=\"".BASE_PATH."img/spacer\" alt='Yes' title='Yes' class='icons'"
                            ." style='height:13px;width:12px;background-position: -7822px 0px;' />"
                        :
                             "<img src=\"".BASE_PATH."img/spacer\" alt='No' title='No' class='icons'"
                            ." style='height:13px;width:12px;background-position: -7834px 0px;' />"
                        )
                        ."</td>\n";
                } else {
                    $out.=
                        ...
                        .($value=="1" ?
                            ...
                            ."geid_set('anchor','row_".$row['ID']."');"
                            .$js_submit.";return false;\">"
                            ."<img class='icons' src='".BASE_PATH."img/spacer'"
                            ." alt=\"Yes - Click for No\" title=\"Yes - Click for No\""
                            ." style='height:13px;width:12px;background-position: -7822px 0px;' /></a>"
                        :
                             "<a title=\"Set to YES\" href=\"#\" onclick=\""
                            ."geid_set('submode','set');"
                            ."geid_set('targetReportID','".$targetReportID."');"
                            ...
                            .$js_submit.";return false;\">"
                            ."<img class='icons' src='".BASE_PATH."img/spacer'"
                            ." alt=\"No - Click for Yes\" title=\"No - Click for Yes\""
                            ." style='height:13px;width:12px;background-position: -7834px 0px;' /></a>"
                        )
                        ."</td>\n";
                }
                break;
            case "tristate":
                ...
                if ($readOnly) {
                    $out.=
                         "    <td>"
                        ."<img src='".BASE_PATH."img/spacer' class='icons'"
                        ." style='height:12px;width:12px;background-position:-".$offset."px 0px;'"
                        ." alt='".$msg_val."' />"
                        ."</td>\n";
                } else {
                    $out.=
                         "    <td>"
                        ."<a title\"".$msg_val." - click to set to ".$msg_next."\" "
                        ."href=\"#\" onclick=\""
                        ."geid_set('targetFieldID','".$column['ID']."');"
                        ."geid_set('submode','set');"
                        ."geid_set('targetReportID','".$targetReportID."');"
                        ."geid_set('targetID','".$targetID."');"
                        ."geid_set('targetValue','".$newVal."');"
                        ."geid_set('anchor','row_".$row['ID']."');"
                        .$js_submit.";return false;\">"
                        ."<img src='".BASE_PATH."img/spacer' class='icons'"
                        ." style='height:12px;width:12px;background-position:-".$offset."px 0px;'"
                        ." alt=\"".$msg_val." - click to set to ".$msg_next."\" />"
                        ."</a></td>";
                }
                break;
            case "url":
            ...
            case "selector_url":
                $value_show = ($value=='./' ?
                    '[home]'
                 :
                    (substr($value, 0, 8)=='./?page=' ? "[".substr($value, 8)."]" : $value)
                );
                ...
                $out.=
                     "    <td class='nowrap'>"
                    .($value!="" ?
                         "<a href=\"".$value."\" title=\"Click to visit this page\" rel='external'>"
                        .str_replace('& ', '&amp; ', $value_show)
                        ."</a>"
                     :
                        "&nbsp;"
                    )
            ...
            case "url_short":
                $out.=
                    "    <td class='nowrap'>"
                    .($value!="" ?
                        "<a href=\"$value\" title=\"Click to visit this page\" rel='external'>Link</a>"
                     :
                        "&nbsp;"
                    )
                    ."</td>\n";
            ...
            case "view_credit_memo":
                $out.=
                     "    <td>"
                    .($value ?
                         "<a href='#' onclick='view_credit_memo(\"".$value."\",800,550);return false;'"
                        ." title='Click to see details for this credit memo'>"
                        .str_replace('& ', '&amp; ', $value)
                        ."</a>"
                     :
                        "&nbsp;"
            ...
            case "view_event_registrants":
                $out.=
                     "    <td><a href=\"".BASE_PATH."report/event_registrants?selectID="
                    .$row['eventID']."&amp;print=2\""
                    ." onclick=\"view_event_registrants('".$row['eventID']."',800,400);return false\""
                    ." title='Click to see registrants for this event'>"
                    .str_replace('& ', '&amp; ', $value)
                    ."</a></td>\n";
                break;
            case "view_order_details":
                $out.=
                     "    <td>"
                    .($value ?
                         "<a href='#' onclick='view_order_details(\"".$value."\",800,550);return false;'"
                        ." title='Click to see details for this order'>".str_replace('& ', '&amp; ', $value)."</a>"
                     :
                        "&nbsp;"
                    )
                    ."</td>\n";
            ...
            case "view_order_pdf":
                $out.=
                     "    <td><a href='#'"
                    ." onclick='download_order_pdf(\"".$value."\",\"".$column['ID']."\",800,550);return false;'>"
                    ."[ICON]16 16 1602 Click to see PDF for this order[/ICON]"
                    ."</a></td>\n";
                break;
            case "view_record_pdf":
                ...
                $out.=
                     "    <td><a href='#'"
                    ." onclick='download_record_pdf(\"".$value."\",\"".$column['ID']."\",800,550);return false;'>"
                    ."[ICON]16 16 1602 Click to see PDF for this record[/ICON]"
                    .$label
                    ."</a></td>\n";
                break;
            default:
