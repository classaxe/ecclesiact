...
class Product_Catalogue extends Base
{
    ...
    protected function _draw_category_description($category_description = '')
    {
    ...
    protected function _draw_category_heading($groupingID, $category_name)
    {
        ...
        return
            "<a name=\"".get_web_safe_ID($category_name)."\" href=\"#\" "
    ...
    protected function _draw_product_groupings_with_items()
    {
        foreach ($this->_product_groupings as $groupingID => $product_grouping) {
            ...
            $this->_html .=
                 ...
                 .$this->_draw_category_description($product_grouping['description'])
            ...
            if ($old_ID != $item['groupingID']) {
                $this->_product_groupings[$item['groupingID']] =
                    array(
                        ...
                        'description' => $item['product_grouping_description'],
                        'items' => array()
                    );
