<?php
define ("VERSION_COMPONENT_ARTICLES_ROTATOR","1.0.6");
/*
Version History:
  1.0.6 (2013-06-07)
...
class Component_Articles_Rotator extends Component_Base {
  ...
  function draw($instance='',$args=array(),$disable_params=false){
    ...
    $parameter_spec =   array(
      ...
      'block_layout' =>             array('match' => '',						'default' =>'Articles',           'hint'=>'Name of Block Layout to use'),
      ...
      'headers_show' =>             array('match' => 'enum|0,1,2',				'default' =>'0',         		  'hint'=>'0|1|2'),
      ...
      'limit_featured' =>           array('match' => 'range|0,n',  				'default' =>'1',                  'hint'=>'0..n'),
      'limit_rotated' =>            array('match' => 'range|0,n',  				'default' =>'1',                  'hint'=>'0..n'),
      'limit_other' =>              array('match' => 'range|0,n',  				'default' =>'1',                  'hint'=>'0..n'),
      ...
      'thumbnail_width' =>          array('match' => '',						'default' =>'',                   'hint'=>'|0..n - give width in px to resize'),
      'title_featured' =>           array('match' => '',						'default' =>'Featured Article',   'hint'=>'title (not plural)'),
      'title_rotated' =>            array('match' => '',						'default' =>'Other Article',      'hint'=>'title (not plural)'),
      'title_other' =>              array('match' => '',						'default' =>'Additional Article', 'hint'=>'title (not plural)'),
    );
    $cp_settings =
    ...
    $results = $Obj_Article->get_records(
      array(
        ...
        'limit' =>              $cp['results_limit'],
        'order_by' =>           $cp['results_order']
      )
    );
    ...
    $out.=
      ...
      .(count($items_rotated_arr) ?
         ...
         ."<div class='clr_b'></div></div>\n"
         .(count($records) && $cp['limit_other'] ? "<hr />\n" : "")
       : ""
       );
    if (count($records) && $cp['limit_other']) {
      ...
      $out.=
         ...
         .($cp['headers_show']>0 ?
             "<h2 class='header'>".$cp['title_other'].(count($records)==1 || $cp['limit_other']==1 ? '' : 's')."</h2>"
           : ""
          );
