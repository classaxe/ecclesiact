...
class Link extends Posting_Container
{
    ...
    public function __construct($ID = "", $systemID = SYS_ID)
    {
        ...
        $this->_cp_vars_listings = array(
            ...
            'box_footer'=>                array(
                'match' =>      '',
                'default' =>    '',
                'hint' =>       'Text below displayed Links'
            ),
            'box_header'=>                array(
                'match' =>      '',
                'default' =>    '',
    ...
    public static function draw_treeview_js($open = false)
    {
        return
             "USETEXTLINKS =    1;\n"
    ...
    public function manage_links()
    {
        ...
        if (!get_var('selectID')) {
            $out.=
                ...
                ."No contents - this ".$this->_get_object_name()." has not been saved yet."
                ."</p>";
        } else {
