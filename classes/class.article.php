...
class Article extends Posting {
  function __construct($ID="",$systemID=SYS_ID) {
    ...
    $this->_cp_vars_detail = array(
      ...
      'block_layout' =>             array('match' => '',                'default' => 'Article',         'hint' => 'Name of Block Layout to use'),
    ...
    $this->_cp_vars_listings = array(
      ...
      'box_title' =>                array('match' => '',                'default' => 'Articles',        'hint' => 'text'),
      'box_title_link' =>           array('match' => 'enum|0,1',        'default' => '0',               'hint' => '0|1'),
      'box_title_link_page' =>      array('match' => '',                'default' => 'all_articles',    'hint' => 'page'),
