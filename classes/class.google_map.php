...
class Google_Map
{
    ...
    public function draw($args = array())
    {
        ...
        if ($control_large) {
            $this->add_control_large();
        }
        if ($control_small) {
            $this->add_control_small();
        }
        if ($control_overview) {
            $this->add_control_overview();
        }
        if ($control_scale) {
            $this->add_control_scale();
        }
        if ($control_type) {
            $this->add_control_type();
        }
        if ($control_zoom) {
            $this->add_control_zoom();
        }
        if ($control_zoom_ondblclick) {
            $this->add_control_zoom_dblclick();
        }
        if ($control_zoom_onscrollwheel) {
            $this->add_control_zoom_scrollwheel();
        }
