...
class Community_Member_Summary extends Community_Member
{
    ...
    protected function _draw_css()
    {
        ...
        $css =
            ...
            ."}\n"
            ."table.summary_data{\n"
            ."  width: 100%; min-width: ".$min_width."px;\n"
            ."  border-collapse: collapse; font-size: 80%; page-break-inside:auto; \n"
            ."}\n"
            ...
            ."  vertical-align: top; width: ".($width_c1-10)."px; min-width: ".($width_c1-10)."px;\n"
            ."  background: ".$color_entry."; text-align: left; border: 1px solid #444; padding:5px;\n"
            ."}\n"
            ...
            ."}\n"
            .".table_details th{\n"
            ."  background: ".$color_data_head."; text-align: left; vertical-align: top;\n"
            ...
            ."  width: 100%; margin: 0.5em 0 0 0; min-width: ".$min_width."px; border-collapse: collapse;\n"
            ."  font-size: 80%; page-break-inside:avoid;\n"
            ."}\n"
    ...
    {
        global $page_vars;
        if (!$this->_current_user_rights['canEdit'] || $this->_valid_token) {
            return;
        }
        $this->_html.=
             "<div class='nav noprint'>\n"
            ."<input type=\"button\" class=\"form_button\" style=\"width:3.2em\""
            ." title=\"View ".$this->_nav_first['title']."\" value=\"&lt;&lt\""
            ." onclick=\"document.location='"
            .BASE_PATH.trim($page_vars['relative_URL'], '/')."/".$this->_nav_first['name']
            ."?print=1&amp;letter_mode=".$this->letter_mode."'\" />"
            ."<input type=\"button\" class=\"form_button\" style=\"width:2.6em\""
            ." title=\"View ".$this->_nav_prev['title']."\" value=\"&lt;\""
            ." onclick=\"document.location='"
            .BASE_PATH.trim($page_vars['relative_URL'], '/')."/".$this->_nav_prev['name']
            ."?print=1&amp;letter_mode=".$this->letter_mode."'\" />"
            ."<input type=\"button\" class=\"form_button\" style=\"width: 6em\" title=\"Toggle Letter Mode\" value=\""
            .($this->letter_mode=='1' ? 'Summary' : 'Letter')
            ."\""
            ." onclick=\"document.location='"
            .BASE_PATH.trim($page_vars['relative_URL'], '/')."/".$this->_record['name']
            ."?print=1".($this->letter_mode=='1' ? '' : '&amp;letter_mode=1')."'\" />"
            ."<input type=\"button\" class=\"form_button\" style=\"width:2.6em\""
            ." title=\"View ".$this->_nav_next['title']."\" value=\"&gt;\""
            ." onclick=\"document.location='"
            .BASE_PATH.trim($page_vars['relative_URL'], '/')."/".$this->_nav_next['name']
            ."?print=1&amp;letter_mode=".$this->letter_mode."'\" />"
            ."<input type=\"button\" class=\"form_button\" style=\"width:3.2em\""
            ." title=\"View ".$this->_nav_last['title']."\" value=\"&gt;&gt;\""
            ." onclick=\"document.location='"
            .BASE_PATH.trim($page_vars['relative_URL'], '/')."/".$this->_nav_last['name']
            ."?print=1&amp;letter_mode=".$this->letter_mode."'\" />\n"
            .($this->letter_mode=='1' ?
                 "<br />\n"
                ."<input type=\"button\" class=\"form_button\" style=\"width: 6em\""
                ." title=\"Edit Member\" value=\"Member\""
                ." onclick=\"details('community_member',".$this->_record['ID'].",780,1020,'','');return false\" />"
                .($this->_record['link_website'] ?
                     "<input type=\"button\" class=\"form_button\" style=\"width: 6em\""
                    ." title=\"View website\" value=\"Website\""
                    ." onclick=\"popWin('".$this->_record['link_website']."','website_'+_CM.ID,"
                    ."'location=1,status=1,scrollbars=1,resizable=1',920,620,1);return false\" />"
                  :
                     ""
                )
                ."<input type=\"button\" class=\"form_button\" style=\"width: 6em\""
                ." title=\"Edit Gallery Profile Images\" value=\"Photos\""
                ." onclick=\"popWin('"
                .BASE_PATH.'communities/'.$this->_cp['community_name']."/gallery/"
                .$this->_record['name']."/profile?print=1','gallery_profile_'+_CM.ID,"
                ."'location=1,status=1,scrollbars=1,resizable=1',920,620,1);return false\" />\n"
                ."<br /><input type=\"button\" class=\"form_button\" style=\"width: 6em;\""
                ." title=\"Edit form letter\" value=\"Letter\""
                ." onclick=\"edit_letter()\" />"
                ."<input type=\"button\" class=\"form_button\" style=\"width: 6em\""
                ." title=\"Edit letter template\" value=\"Template\""
    ...
    {
        if ($this->_current_user_rights['canEdit'] && !$this->letter_mode && !$this->_valid_token) {
            return;
        }
        ...
        return
            ...
            ."<div class='tagline'>\n"
            ."<a href=\"/\" rel=\"external\">"
            ."<img alt=\"Ecclesiact ChurchesInYourTown.ca - Connecting The Body of Christ\""
    ...
    protected function _draw_items($content)
    {
        ...
        $ATTN = (trim($r['contact_NTitle'].$r['contact_NFirst'].$r['contact_NLast'])!='' ?
             $r['contact_NTitle'].' '
            .$r['contact_NFirst'].' '
            .$r['contact_NLast']
          :
         ...
         $ADDRESS = ($r['mailing_addr_line1']!='' && $r['mailing_addr_line1']!=$r['service_addr_line1'] ?
                "c/o: "
               :
                ""
            )
         ...
         $SITE_LINK =
            "<a href=\"".$this->_community_record['URL_external']."\" rel=\"external\">".$c_arr[1]."</a>";
         $SITE_SERVER =     $c_arr[1];
    ...
    protected function _draw_letter_sponsors($width)
    {
        ...
        foreach ($images as $image) {
            ...
            $out.=
                ...
                ."<img src=\"".BASE_PATH."img/resize/".trim($img, '/')
                ."?width=".$image_width."&amp;height=100&amp;maintain=1\""
                ." alt=\"".$image['title']."\" />"
                ."</a>\n"
                ."</td>\n";
        }
    ...
    protected function _draw_checklist_comments_signoff()
    {
        ...
        $this->_draw_checklist_table_open(
            'summary_signoff'
        );
        $this->_draw_checklist_table_entry(
            "Prayer Requests",
            "<div style='height:60px'>&nbsp;</div>",
            false,
            "<p>May we pray for you? Please let us know.</p>"
        );
        $this->_draw_checklist_table_entry(
            "Potential Partners",
            "<div style='height:60px'>&nbsp;</div>",
            false,
            "<p>Please call us if you'd like more information.</p>"
        );
        $this->_draw_checklist_table_entry(
            "Comments / Suggestions",
            "<div style='height:60px'>&nbsp;</div>",
            false,
            "<p>We'd love to hear from you. Attach another sheet if you like.</p>"
        );
        $this->_draw_checklist_table_entry(
    ...
    protected function _draw_checklist_designated_contact()
    {
        ...
        $content =
            ...
            ." summary='Table showing internet services'>"
            ."  <thead>\n"
            ."    <tr>\n"
    ...
    protected function _draw_checklist_internet_services()
    {
        $entries = array(
            array(
                'link_website',
                'Website',
                'width:16px;height:16px;margin:0px 5px 2px 0px;background-position:-800px 0px;float:left;'
            ),
            array(
                'link_facebook',
                'Facebook',
                'width:14px;height:14px;margin:0px 5px 2px 0px;background-position:-3147px 0px;float:left;'
            ),
            array(
                'link_twitter',
                'Twitter',
                'width:14px;height:14px;margin:2px 5px 2px 0px;background-position:-5420px 0px;float:left;'
            ),
            array(
                'link_video',
                'Video',
                'width:16px;height:16px;margin:0px 5px 2px 0px;background-position:-7966px 0px;float:left;'
            )
        );
        $content =
             "<table class='table_details' cellpadding='0' cellspacing='0' border='1'"
        ...
        foreach ($entries as $e) {
            ...
            $entry =  ($this->_record[$e[0]] ?
                "<a rel=\"external\" href=\"".$this->_record[$e[0]]."\">".$this->_record[$e[0]]."</a>"
             :
                ""
            );
        ...
        $this->_draw_checklist_table_entry(
            ...
            $content,
            true,
            '<p>* Video is for Youtube, UStream, Livestream, Vimeo or other video provider channel page</p>'
        );
    }
    ...
    {
        $content = ($this->_current_user_rights['isEditor'] ?
             "<a"
            ." title=\"Click to edit this member\""
            ." href=\"".BASE_PATH."details/".$this->_report."/".$this->_record['ID']."\""
            ." onclick=\"details('"
            .$this->_report."',".$this->_record['ID'].",".$this->_popup['h'].",".$this->_popup['w']
            .",'','');return false;\">"
    ...
    protected function _draw_checklist_office_email()
    {
        ...
        $content.=
            ...
            ."</table>\n";
        $note =
             "<p>* Email addresses are not shown on the website.</p>"
    ...
    protected function _draw_checklist_office_phone()
    {
        ...
        $content =
            ...
            ."  </thead>\n"
            ."  <tbody>\n"
            .$this->_draw_2col_entry(
                ($r['office_phone1_lbl'] ? $r['office_phone1_lbl'] : "&nbsp;"),
                $r['office_phone1_num'],
                true,
                'td'
            )
            .$this->_draw_2col_entry(
                ($r['office_phone2_lbl'] ? $r['office_phone2_lbl'] : "&nbsp;"),
                $r['office_phone2_num'],
                true,
                'td'
            )
    ...
    protected function _draw_checklist_photos()
    {
        ...
        if ($slides = $this->get_member_profile_images()) {
            foreach ($slides as $slide) {
                if ($slide['enabled']) {
                    $img = ($slide['thumbnail_small'] && file_exists('.'.$slide['thumbnail_small']) ?
            ...
            $heading =  "Profile Photos";
            $content =  "<div class='profile_photos'>".implode($photos)."</div>\n";
            $note = ($this->_record['featured_image'] && file_exists('.'.$this->_record['featured_image']) ?
    ...
    protected function _draw_checklist_preamble()
    {
        ...
        $this->_html.=
            ...
            .($this->_current_user_rights['canEdit']?
                 "<p>Please help us to ensure the accuracy of your community website profile"
                ." by reviewing this checklist.</p>"
                ."<p>Kindly indicate any changes required (include a separate sheet if necessary),"
    ...
    protected function _draw_checklist_service_times()
    {
        ...
        $content =
             "<table class='table_details' cellpadding='0' cellspacing='0' border='1'"
            ." summary='Table showing service times'>"
            ."  <thead>\n"
            ."    <tr>\n"
            ."      <th style='width:7em'>Day</th>\n"
    ...
    protected function _draw_checklist_table_entry($label, $content, $controls = true, $note = false)
    {
        ...
        $this->_html.=
            ...
            ."      ".$q.'. '.$label
            .($note ?
                "      <div id=\"qc_".$q."\" class='entry_note'>".$note."</div>\n"
             :
                ""
            )
            ."    </th>\n"
    ...
    protected function _setup($cp, $member_extension)
    {
        ...
        $this->_valid_token =   get_var('token') == $this->_get_ID();
    }
