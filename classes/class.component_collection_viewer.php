<?php
define ("VERSION_COMPONENT_COLLECTION_VIEWER","1.0.48");
/*
Version History:
  1.0.48 (2014-03-21)
    1) Now reports if an invalid authr or album is selected and issues a 404

  (Older version history in class.component_collection_viewer.txt)
*/
class Component_Collection_Viewer extends Component_Base {
  var $_cm_podcast =                    '';
  var $_cm_podcastalbum =               '';
  var $_paging_controls_current_pos =   '';
  var $_paging_controls_html =          '';
  var $_path =                          '';
  var $_path_ext =                      '';
  var $_path_real =                     '';
  var $_podcast_albums =                array();
  var $_podcast_authors =               array();
  var $_podcast_selected =              false;
  var $_records =                       array();
  var $_records_total =                 0;
  var $_selected_album =                '';
  var $_selected_album_ID =             0;
  var $_selected_album_label =          false;
  var $_selected_album_memberID =       0;
  var $_selected_album_communityID =    0;
  var $_selected_album_default_folder = '';
  var $_selected_album_title =          '';
  var $_selected_author =               '';
  protected $_selected_author_label =   false;
  var $_selected_podcast =              '';
  ...
  public function __construct(){
    ...
    $this->_parameter_spec = array(
      'audioplayer_width' =>            array('match' => 'range|160,n',     'default'=>'320',               'hint'=>'0..x'),
      'author_show' =>                  array('match' => 'enum|0,1',        'default'=>'1',                 'hint'=>'0|1'),
      'block_layout_albums' =>          array('match' => '',                'default' =>'Podcast Album',    'hint'=>'Block Layout to use to render albums'),
      'block_layout_items' =>           array('match' => '',                'default' =>'Podcast',          'hint'=>'Block Layout to use to render items'),
      'box' =>                          array('match' => 'enum|0,1,2',      'default'=>'0',                 'hint'=>'0|1|2'),
      'box_footer' =>                   array('match' => '',                'default'=>'',                  'hint'=>'Text below displayed Podcasts'),
      'box_header' =>                   array('match' => '',                'default'=>'',                  'hint'=>'Text above displayed Podcasts'),
      'box_rss_link' =>                 array('match' => 'enum|0,1',        'default'=>'0',                 'hint'=>'0|1'),
      'box_title' =>                    array('match' => '',                'default'=>'Podcasts',          'hint'=>'text'),
      'box_title_link' =>               array('match' => 'enum|0,1',        'default'=>'0',                 'hint'=>'0|1'),
      'box_title_link_page' =>          array('match' => '',                'default'=>'all_podcasts',      'hint'=>'page'),
      ...
      'controls_albums_heading' =>      array('match' => '',                'default' =>'Albums',           'hint'=>'Label to place above podcast albums where listed'),
      'controls_albums_show' =>         array('match' => 'enum|0,1',        'default' =>'1',                'hint'=>'Whether or not to include podcast albums in list'),
      'controls_albums_url' =>          array('match' => '',                'default' =>'album',            'hint'=>'URL portion to make album selection'),
      'controls_authors_heading' =>     array('match' => '',                'default' =>'Authors',          'hint'=>'Label to place above podcast authors where listed'),
      'controls_authors_show' =>        array('match' => 'enum|0,1',        'default' =>'1',                'hint'=>'Whether or not to include podcast authors in list'),
      'controls_authors_url' =>         array('match' => '',                'default' =>'author',           'hint'=>'URL portion to make author selection'),
      'controls_color_active' =>        array('match' => 'hex3|#e0e0ff',    'default'=>'#e0e0ff',           'hint'=>'Hex colour code for control button when active'),
      'controls_color_active_over' =>   array('match' => 'hex3|#e8e8a0',    'default'=>'#e8e8a0',           'hint'=>'Hex colour code for control button when active and hovered over'),
      'controls_color_border' =>        array('match' => 'hex3|#c0c0ff',    'default'=>'#c0c0ff',           'hint'=>'Hex colour code for control button borders'),
      'controls_color_normal' =>        array('match' => 'hex3|#ffffff',    'default'=>'#ffffff',           'hint'=>'Hex colour code for control button when inactive'),
      'controls_color_over' =>          array('match' => 'hex3|#ffff80',    'default'=>'#ffff80',           'hint'=>'Hex colour code for control button when inactive and hovered'),
      'controls_important_heading' =>   array('match' => '',                'default' =>'Featured Albums',  'hint'=>'Label to place above podcast albums listed as important'),
      'controls_important_show' =>      array('match' => 'enum|0,1',        'default' =>'1',                'hint'=>'Whether or not to break out albums flagged as important'),
      'controls_width' =>               array('match' => 'range|0,n',       'default'=>'250',               'hint'=>'0..x'),
      'extra_fields_list' =>            array('match' => '',                'default'=>'',                  'hint'=>'CSV list format: field|label|group,field|label|group...'),
      'filter_album_order_by' =>        array('match' => 'enum|date,title', 'default' =>'date',             'hint'=>'date|title'),
      ...
      'item_footer_component' =>        array('match' => '',                'default'=>'',                  'hint'=>'Name of component rendered below each displayed Podcast'),
      ...
      'selected_thumbnail_at_top' =>    array('match' => 'enum|0,1',        'default' =>'0',                'hint'=>'0|1'),
      'selected_thumbnail_height' =>    array('match' => 'range|1,n',       'default' =>'300',              'hint'=>'|1..n or blank - height in px to resize'),
      'selected_thumbnail_image' =>     array('match' => 'enum|s,m,l',      'default' =>'s',                'hint'=>'s|m|l - Choose only \'s\' unless Multiple-Thumbnails option is enabled'),
      'selected_thumbnail_link' =>      array('match' => 'enum|0,1',        'default' =>'1',                'hint'=>'0|1'),
      'selected_thumbnail_show' =>      array('match' => 'enum|0,1',        'default' =>'0',                'hint'=>'0|1'),
      'selected_thumbnail_width' =>     array('match' => 'range|1,n',       'default' =>'400',              'hint'=>'|1..n or blank - width in px to resize'),
      'selected_video_height' =>        array('match' => 'range|0,n',       'default' =>'300',              'hint'=>'0|x'),
      'selected_video_width' =>         array('match' => 'range|0,n',       'default' =>'400',              'hint'=>'0|x'),
      'selected_video_show' =>          array('match' => 'enum|0,1',        'default' =>'1',                'hint'=>'0|1 - Whether or not to allow video to show'),
      'show_uploader' =>                array('match' => 'enum|0,1',        'default' =>'1',                'hint'=>'0|1'),
      ...
      'text_prompt_to_choose' =>        array('match' => '',                'default' =>'<h2>Podcasts</h2><p>Please make a selection from the choices shown',                'hint'=>'Text to display if not choice has been made'),
      ...
      'thumbnail_show' =>               array('match' => 'enum|0,1',        'default' =>'0',                'hint'=>'0|1'),
      ...
      'video_height' =>                 array('match' => 'range|0,n',       'default' =>'180',              'hint'=>'0|x'),
      'video_width' =>                  array('match' => 'range|0,n',       'default' =>'240',              'hint'=>'0|x'),
      'video_show' =>                   array('match' => 'enum|0,1',        'default' =>'1',                'hint'=>'0|1 - Whether or not to allow video to show'),
    );
  }
  ...
  protected function _draw_admin_uploader(){
    global $page_vars;
    if (!$this->_current_user_rights['canEdit'] || $this->_cp['show_uploader']!=1 || $this->_selected_album_ID==false){
      return;
    }
  ...
  protected function _draw_podcasts(){
    ...
    $html.= (isset($this->_Obj_Block_Layout->record['listings_panel_header']) ? $Obj_Podcast->convert_Block_Layout($this->_Obj_Block_Layout->record['listings_panel_header']) : '');
    if ($this->_selected_album!='' && $this->_selected_album_label===false){
    ...
    else if ($this->_selected_author!='' && $this->_selected_author_label===false){
      $html.= "<b>Error:</b><br />No such author as ".$this->_selected_author;
      header("Status: 404 Not Found",true,404); // Keep those pesky bots from following dead links!
    }
    else if ($this->_selected_author!='' || $this->_selected_album!=''){
      $html.= $Obj_Podcast->convert_Block_Layout($this->_Obj_Block_Layout->record['listings_group_header']);
      ...
      foreach($this->_podcasts_selected as $podcast){
        ...
        if ($i>0 && !$Obj_Podcast->_draw_detail_test_if_grouping_has_changed()){
          $html.=  $Obj_Podcast->convert_Block_Layout($this->_Obj_Block_Layout->record['listings_group_separator']);
        }
        if($i>0){
          $html.=    $Obj_Podcast->convert_Block_Layout($this->_Obj_Block_Layout->record['listings_item_separator']);
        }
        $html.=    $Obj_Podcast->convert_Block_Layout($this->_Obj_Block_Layout->record['listings_item_detail']);
        $i++;
      }
      $html.= $Obj_Podcast->convert_Block_Layout($this->_Obj_Block_Layout->record['listings_group_footer']);
    }
    $html.=
       (isset($this->_Obj_Block_Layout->record['listings_panel_footer']) ?
          $Obj_Podcast->convert_Block_Layout($this->_Obj_Block_Layout->record['listings_panel_footer'])
        : ''
       );
...
//      y($this);
  ...
  protected function _draw_podcast_selected(){
    ...
    $Obj_Podcast->record['parentTitle'] = ($this->_selected_album!='' ? $this->_selected_album_label :  $this->_selected_author_label);
    $Obj_Podcast->xmlfields_decode($Obj_Podcast->record);
...
//    y($this->_Obj_Block_Layout->record);die;
    $html=
  ...
  protected function _load_podcast_albums(){
    ...
    $result = $Obj->get_records(
      array(
        'category' =>         ($this->_cp['filter_category_list']!='' ?         $this->_cp['filter_category_list'] : ''),
        'category_master' =>  (isset($this->_cp['filter_category_master']) ?    $this->_cp['filter_category_master'] : ''),
        ...
        'memberID' =>         (isset($this->_cp['filter_memberID']) ?           $this->_cp['filter_memberID'] : 0),
        'personID' =>         (isset($this->_cp['filter_personID']) ?           $this->_cp['filter_personID'] : 0),
  ...
  static function _load_podcast_albums_sort_date($a, $b){
    if ($a['date'] == $b['date']) {
        return 0;
    }
  ...
  static function _load_podcast_albums_sort_title($a, $b){
    if ($a['title'] == $b['title']) {
        return 0;
    }
  ...
  static function _load_podcast_authors_sort($a, $b){
  ...
  protected function _load_podcast_selected(){
    foreach ($this->_podcasts as $record){
      if ($this->_selected_album_ID==$record['parentID'] && trim(strToLower($record['name']))==trim(strToLower($this->_selected_podcast))){
  ...
  protected function _load_podcasts(){
    ...
    $result = $Obj->get_records(
      array(
        ...
        'order_by' =>         ($this->_cp['filter_podcast_order']=='asc' ? 'date_a' : 'date')
      )
    );
    ...
    foreach ($this->_podcasts as $p){
      if ($this->_selected_author=='' || $this->_selected_author=='*' || get_web_safe_ID($p['author'])==$this->_selected_author || ($p['author']=='' && $this->_selected_author=='not-specified')){
  ...
  protected function _draw_listings_load_paging_controls(){
    ...
    if (!isset($_REQUEST['command']) || $_REQUEST['command']!=$this->_safe_ID."_load"){
      Page::push_content(
        ...
        ."  var fn = function(){hidePopWin(null);externalLinks();\$('#".$this->_safe_ID."_content_inner audio').mediaelementplayer();"
        .(Base::module_test('Church') ? "Logos.ReferenceTagging.tag(\$J('#".$this->_safe_ID."_content_inner')[0])" : "")
        ."};\n"
        ."  show_popup_please_wait();\n"
        ."  ajax_post_streamed(base_url+'".trim($page_vars['path'],'/')."','".$this->_safe_ID."_content_inner',post_vars,fn);\n"
        ."  return false;\n"
        ."}"
      );
    }
      ...
      case 1:
        $this->_paging_controls_html=
           ...
           .($this->_filter_offset>0 ?
            ...
            ." onclick=\"".$this->_safe_ID."_paging(".($this->_filter_offset+$this->_cp['results_limit']*-1).");\""
            ." />"
           : ""
           )
      ...
      case 2:
        ...
        $this->_paging_controls_html.=
          ...
          .($this->_filter_offset>0 ?
             ...
             ." href=\"".BASE_PATH.trim($page_vars['path'],'/')."?offset=".($this->_filter_offset+$this->_cp['results_limit']*-1)."\""
             ." onclick=\"return ".$this->_safe_ID."_paging(".($this->_filter_offset+$this->_cp['results_limit']*-1).");\""
        ...
        for ($i=0; $i<$pages; $i++) {
          $this->_paging_controls_html.=
            ...
            ." href=\"".BASE_PATH.trim($page_vars['path'],'/')."?offset=".($this->_cp['results_limit']*$i)."\""
            ." class='"
        ...
        $this->_paging_controls_html.=
          ...
          .($this->_filter_offset+$this->_cp['results_limit']<$this->_records_total ?
             ...
             ." href=\"".BASE_PATH.trim($page_vars['path'],'/')."?offset=".($this->_filter_offset+$this->_cp['results_limit'])."\""
             ." onclick=\"return ".$this->_safe_ID."_paging(".($this->_filter_offset+$this->_cp['results_limit']).");\""
