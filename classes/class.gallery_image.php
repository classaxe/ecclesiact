    ...
    public function __construct($ID = "", $systemID = SYS_ID)
    {
        ...
        $this->_cp_vars_detail = array(
            ...
            'products_msg_howto' =>       array(
                'match' =>      '',
                'default' =>    '<p>Click the shopping-cart icon to select payment option, then proceed to the'
                                .' Checkout to place your order.<br />Use the +/- buttons to adjust quantities.</p>',
            ...
            'products_msg_signin' =>      array(
                'match' =>      '',
                'default' =>    '<p>There are products that cannot be seen unless you sign in.<br />'
            ...
            'products_signin' =>          array(
                'match' =>      'enum|0,1',
                'default' =>    '1',
                'hint' =>       '0|1 - whether or not to show a signin dialog if products available for members'
        ...
        $this->_cp_vars_listings = array(
            ...
            'block_layout_for_associated' => array(
                'match' =>      '',
                'default' =>    'Gallery Image for Associated',
            ...
            'box_footer' =>               array(
                'match' =>      '',
                'default' =>    '',
                'hint' =>       'Text below displayed Gallery Images'
            ),
            'box_header' =>               array(
                'match' =>      '',
                'default' =>    '',
                'hint' =>       'Text above displayed Gallery Images'
            ),
            'box_rss_link' =>             array(
                'match' =>      'enum|0,1',
                'default' =>    '0',
            ...
            'results_order' =>            array(
                ...
                'default' =>    'date',
                'hint' =>       'date|name|title - or by arranged sequence IF you gave a filter_container_path'
            ),
