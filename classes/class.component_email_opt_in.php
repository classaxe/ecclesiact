<?php
  define ("VERSION_COMPONENT_EMAIL_OPT_IN","1.0.0");
/*
Version History:
  1.0.0 (2014-06-22)
    1) Initial release
*/
class Component_Email_Opt_In extends Component_Base {
  public function __construct(){
    $this->_ident =         'email_opt_in';
    $this->_parameter_spec = array(
      'show_subscription_details' =>    array('match' => 'enum|0,1',        'default'=>'1',                 'hint'=>'0|1'),
      'text_title' =>                   array('match' => '',                'default'=> "Confirm Email Subscription",  'hint'=>'Text to place above component'),
    );
  }
  ...
  protected function _draw_controls(){
    $this->_html .=
      ...
      ."<input type=\"button\" value=\"Confirm\" onclick=\"if(confirm('Do you wish to receive messages from us?')){geid_set('submode','all');geid('form').submit();}\" style=\"width:8em\"/>\n"
        ...
        foreach($records as $r){
          if($r['systemID']==SYS_ID){
            ...
            if($current['permEMAILRECIPIENT']==1){
              $permArr = array('permEMAILOPTIN'=>1,'permEMAILOPTOUT'=>0);
