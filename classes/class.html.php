...
class HTML extends Record {
  ...
  static function draw_form_box($title, $content='', $help='', $shadow=0, $width=false, $footer=''){
    ...
    return
      ...
      .($report_name!='' && $ID!='' ? " ".HTML::draw_icon('print_form',array('report_name'=>$report_name,'ID'=>$ID)) : "")
      ."</div>"
  ...
  function draw_icon($type,$args=false) {
    // Handle simple disabled icons first:
    switch ($type) {
      case 'Disabled Edit Article':
        $pos = 2380;  $width = 15; $text = "(Edit Article)";
      break;
      case 'Disabled Edit Event':
        $pos = 2425;  $width = 20; $text = "(Edit Event)";
      break;
      case 'Disabled Edit Job Posting':
        $pos = 2410;  $width = 15; $text = "(Edit Job Posting)";
      break;
      case 'Disabled Edit News Item':
        $pos = 2395;  $width = 15; $text = "(Edit News Item)";
      break;
      case 'Disabled Edit Page':
        $pos = 2347;  $width = 18; $text = "(Edit Page)";
      break;
      case 'Disabled Edit Podcast':
        $pos = 2445;  $width = 17; $text = "(Edit Podcast)";
      break;
      case 'Popup Edit Article':
        $pos = 2462;  $width = 18; $text = "Edit Article in a popup window";
      break;
      case 'Popup Edit Event':
        $pos = 2516;  $width = 18; $text = "Edit Event in a popup window";
      break;
      case 'Popup Edit Job Posting':
        $pos = 2498;  $width = 18; $text = "Edit Job Posting in a popup window";
      break;
      case 'Popup Edit News Item':
        $pos = 2480;  $width = 18; $text = "Edit News Item in a popup window";
      break;
      case 'Popup Edit Podcast':
        $pos = 2534;  $width = 18; $text = "Edit Podcast in a popup window";
      break;
      case 'Popup Edit Product':
        $pos = 4182;  $width = 18; $text = "Edit Product in a popup window";
      break;
    }
    switch ($type) {
      case 'Disabled Edit Article':
      ...
      case 'bookmark':
        ...
        $URL =          ($_SERVER["SERVER_PORT"]==443 ? "https://" : "http://").$_SERVER["HTTP_HOST"].BASE_PATH.trim($page_vars['path'],'/');
        $out =          Component_Base::get_help($ident, '', false, $parameter_spec, $cp_defaults);
        if (!$cp['disable']) {
          $out.=
             ($out ? "<br />" : "")
            ."<span class='noprint' title='Click to add a bookmark'"
            ." onmouseover=\"geid('icon_bookmark').style.backgroundPosition='-876px 0px';window.status='Click to add a bookmark';return true;\""
            ." onmouseout=\"geid('icon_bookmark').style.backgroundPosition='-861px 0px';window.status='';return true;\""
            ."><a href=\"#\" onclick=\"add_bookmark('".$URL."','".addslashes($page_vars['title'])."');return false;\">"
            ."<img alt='Add Bookmark' id='icon_bookmark' src='".BASE_PATH."img/spacer' class='toolbar_icon'"
            ." style=\"background-position:-861px 0px;\""
            ." height=\"15\" width=\"15\""
            ."/></a>"
            .($cp['show_label'] ? "<a href=\"#\" onclick=\"add_bookmark('".$URL."','".addslashes($page_vars['title'])."');return false;\" style=\"float:left\">".$cp['label']."</a>" : "")
            ."</span>";  }
        return $out;
      break;
      case "buy_event":
      ...
      case 'print':
        return
           "<span class='noprint'><a href=\"#\" onclick=\"if(window.print){window.print();}else{alert('Please press the Print icon above.');}return false;\""
          ." onmouseover=\"geid('icon_print').style.backgroundPosition='-1476px 0px';window.status='Print this page';return true;\""
          ." onmouseout=\"geid('icon_print').style.backgroundPosition='-1456px 0px';window.status='';return true;\""
          .">"
          ."<img alt='Print this page' id='icon_print' src='".BASE_PATH."img/spacer' title='Print this page' class='toolbar_icon'"
      ...
      case 'print_calendar':
        return
          ...
          ." onclick=\"alert('The calendar prints out best in landscape mode -\\n\\nThe easiest way to achieve this is choose\\n\'Print preview\' from this window\'s File menu\\nthen change the orientation to landscape\\nbefore you actually print.\\n\\n(Press \'Alt\' if you can\'t see the File menu)');if(window.print){window.print();}else{alert('Please press the Print icon above.');}return false;\" "
          ." onmouseover=\"geid('icon_print_calendar').style.backgroundPosition='-1476px 0px';window.status='Print this calendar';return true;\" "
          ." onmouseout=\"geid('icon_print_calendar').style.backgroundPosition='-1456px 0px';window.status='';return true;\""
          .">"
          ."<img alt='Print this calendar' id='icon_print_calendar' src='".BASE_PATH."img/spacer' title='Print this calendar' class='toolbar_icon'"
          ." style='background-position:-1456px 0px;'"
          ." height=\"16\" width=\"20\""
          ."/></a></span>";
      break;
      case 'print_form':
        return
          ...
          ." onmouseover=\"geid('icon_print_form').style.backgroundPosition='-2824px 0px';window.status='Print this page';return true;\""
          ." onmouseout=\"geid('icon_print_form').style.backgroundPosition='-2811px 0px';window.status='';return true;\""
          .">"
          ."<img alt='Click to print' id='icon_print_form' src='".BASE_PATH."img/spacer' title='Click to print' class='icons'"
      ...
      case 'print_friendly':
        ...
        if (!$cp['disable']){
          $out.=
             ($out ? "<br />" : "")
            ."<span class='noprint' title='Click to see a Print-Friendly \nversion of this ".$page_vars['object_name']."'"
            ." onmouseover=\"geid('icon_print').style.backgroundPosition='-1476px 0px';window.status='Click to see a Print-Friendly version of this ".$page_vars['object_name']."';return true;\""
            ." onmouseout=\"geid('icon_print').style.backgroundPosition='-1456px 0px';window.status='';return true;\""
            ...
            ." height=\"16\" width=\"20\""
            ."/></a>"
            .($cp['show_label'] ? "<a href=\"#\" style=\"float:left\" onclick=\"print_friendly();return false;\">".$cp['label']."</a>" : "")
            ."</span>";
        }
        return $out;
      break;
      ...
      case 'sitemap':
        ...
        if (!$cp['disable']) {
          $out.=
            ...
            ." onmouseover=\"geid('icon_sitemap').style.backgroundPosition='-1512px 0px';window.status='Click to view Sitemap';return true;\""
            ." onmouseout=\"geid('icon_sitemap').style.backgroundPosition='-1496px 0px';window.status='';return true;\""
            ."><a href=\"".$cp['URL']."\">"
            ...
            ."/>"
            ."</a>"
            .($cp['show_label'] ? "<a href=\"".$cp['URL']."\" style=\"float:left\">".$cp['label']."</a>" : "")
            ."</span>";  }
        return $out;
      break;
      case 'text_sizer':
        ...
        if (!$cp['disable']) {
          $out.=
            ...
            ." onmouseover=\"geid('icon_textsizer_enlarge').style.backgroundPosition='-1576px 0px';window.status='Click to Enlarge Text';return true;\""
            ." onmouseout=\"geid('icon_textsizer_enlarge').style.backgroundPosition='-1528px 0px';window.status='';return true;\""
            .($size=='big' ? " style='display:none'" : "")
            .">"
            ."<a href=\"#\" onclick=\"toggleTextSize();return false;\""
            .">"
            ."<img alt='Enlarge Text' id='icon_textsizer_enlarge' src='".BASE_PATH."img/spacer' class='toolbar_icon'"
            ." style='background-position:-1528px 0px;'"
            ." height=\"16\" width=\"16\""
            ."/></a>"
            .($cp['show_label'] ? "<a href=\"#\" style=\"float:left\" onclick=\"toggleTextSize();return false;\">".$cp['label']."</a>" : "")
            ."</span>"
            ."<span id='text_sizer_reduce' title='Click to Reduce Text'"
            ." onmouseover=\"geid('icon_textsizer_reduce').style.backgroundPosition='-1560px 0px';window.status='Click to Reduce Text';return true;\""
            ." onmouseout=\"geid('icon_textsizer_reduce').style.backgroundPosition='-1544px 0px';window.status='';return true;\""
            .($size=='big' ? "" : " style='display:none'")
            .">"
            ."<a href=\"#\" onclick=\"toggleTextSize();return false;\""
            .">"
            ."<img alt='Reduce Text' id='icon_textsizer_reduce' src='".BASE_PATH."img/spacer' class='toolbar_icon'"
            ." style='background-position:-1544px 0px;'"
            ." height=\"16\" width=\"16\""
            ."/></a>"
            .($cp['show_label'] ? "<a href=\"#\" style=\"float:left\" onclick=\"toggleTextSize();return false;\">".$cp['label']."</a>" : "")
            ."</span>"
  ...
  function draw_info($title,$content) {
    return
       "<div class='info'>"
      ."<h1>".$title."</h1>"
      ."<img alt='Info' src='".BASE_PATH."img/spacer' class='icons' style='height:11px;width:11px;background-position:-2600px 0px;' />\n"
      .$content
      ."</div>";
  }
  ...
  function draw_section_tabs($arr, $divider_prefix, $selected_section, $js="") {
    ...
    if (count($ID_arr) && (!isset($selected_section) || $selected_section=="" || !in_array($selected_section,$ID_arr))) {
  ...
  function draw_section_tab_buttons($arr, $divider_prefix, $selected_section, $js="") {
    $divider_prefix = str_replace(array(' ',':','.','-'),array('_','_','_','_'),$divider_prefix);
    $ID_arr = array();
    foreach ($arr as $value) {
      $safe_ID = str_replace(array('/'),'_',$value['ID']);
    ...
    foreach ($arr as $value) {
      if ($value['label']!="") {
        ...
        $out.=
          ...
          ." id='section_".$safe_ID."_heading'"
          .(isset($value['width']) && $value['width'] ? " style=\"min-width:".$value['width']."px\"" : "")
          ." onclick=\"".($js ? $js.";" : "")."return show_section_tab(spans_".$divider_prefix.",'".$safe_ID."')\""
          .">"
          ."<a "
          ."title=\"Click to view ".str_replace('<br />',' ',$value['label'])."\""
          ." onclick='return false;'>".$value['label']."</a></div>\n";
  ...
  function draw_section_tab_div($ID,$selected_section) {
    ...
    return
      "<div id='section_".$safe_ID."' class='section_container' style='".($selected_section==$safe_ID ? '' : 'left:-10000px;').";'>";
  }

  function draw_status($ID,$msg,$ajax_mode=false,$severity=false,$noclose=0) {
    if (!$msg) {
      return "";
    }
    $severity=false;
    if ($severity === false){
      ...
      else if (substr(strip_tags($msg),0,6)=='Notice'){
        $severity = 1;
      }
      else if (substr(strip_tags($msg),0,7)=='Warning'){
        $severity = 1;
      }
      else {
        $severity = 0;
  ...
  function draw_toolbar($type,$args=array()){
    global $system_vars;
    $this->_args = $args;
  ...
  protected function _draw_toolbar_load_user_rights(){
    ...
    $isAPPROVED =       ($isMASTERADMIN || $isSYSADMIN || $isUSERADMIN || $isSYSAPPROVER || $isSYSEDITOR || $isSYSMEMBER);
    ...
    $this->_current_user_rights['canEdit'] =            ($isMASTERADMIN || $isSYSADMIN || $isSYSAPPROVER || $isSYSEDITOR ? 1 : 0);
    $this->_isAdmin =                                   ($this->_current_user_rights['canEdit'] || $isUSERADMIN ? 1 :0);
  ...
  protected function _draw_toolbar_type_admin(){
    ...
    foreach ($records as $record){
      ...
      $html.=
        ...
        .($this->_current_user_rights['isMASTERADMIN'] ? " onmouseover=\"_CM.type='report';_CM.ID='".$record['ID']."';\"" : "")
        .($this->_current_user_rights['isMASTERADMIN'] ? " onmouseout=\"_CM.type=''\"" : "")
        ." onclick=\"show_popup_please_wait();return true;\">"
        ."          <span class='ami'>".$record['icon']."</span>\n"
        ."          <span class='aml'>".$record['label']."</span>\n"
        ."        </a>\n"
        .($record['help'] ?
             "        <a class='amh' href=\"".BASE_PATH.$record['help']."\" onclick=\"popup_help('".$record['help']."');return false\">"
  ...
  protected function _draw_toolbar_type_component(){
    global $page_vars;
    if (!$this->_current_user_rights['isMASTERADMIN'] || !isset($page_vars['componentID_post']) || $page_vars['componentID_post']==1) {
      return '';
    }
    $popup_c = get_popup_size('component');
    $content =
       "<a class='ti' "
      ."href=\".\" onclick=\"details('component',".$page_vars['componentID_post'].",'".$popup_c['h']."','".$popup_c['w']."');return false;\">"
      ."[ICON]17 17 1373 Edit embedded component[/ICON]</a>";
  ...
  protected function _draw_toolbar_type_custom_form(){
    ...
    return
       ...
       ."<a class='ti' href=\"#\" onclick=\"details('custom_forms','".$this->_args['ID']."','".$popup_c['h']."','".$popup_c['w']."');return false;\">"
       ."[ICON]17 17 2627 Edit Custom Form[/ICON]</a>\n"
       ."<a class='ti' href=\"#\" onclick=\"validate_at_w3c('".$this->_args['ID']."',600,800);return false;\">"
       ."[ICON]17 17 2644 Validate Custom Form[/ICON]</a>\n"
       .HTML::draw_toolbar_separator()
       ."<a class='ti' rel='external'"
       ." href=\"".BASE_PATH."export/sql/custom_forms/?targetID=".$this->_args['ID']."\">"
       ."[ICON]25 25 2661 Export Custom Form[/ICON]</a>\n"
       ."<a class='ti' rel='external'"
       ." href=\"".BASE_PATH."?command=download_custom_form_xml&amp;targetID=".$this->_args['ID']."\">"
       ."[ICON]32 32 2686 View XML for Custom Form[/ICON]</a>\n"
  ...
  protected function _draw_toolbar_type_page_create(){
    ...
    return
      ...
      ."[ICON]18 18 2090 Create a brand new page named &quot;".$page_arr[0]."&quot;[/ICON]</a>\n"
      .HTML::draw_toolbar_end()
      ."<div class='clear'>&nbsp;</div>\n"
      ."<h3 class='margin_none padding_none'>Page ".$page." not found</h3>"
      ."<p>This Page does not yet exist for this Site.<br />\n"
      ."You now have the option to create it.</p>"
      .($this->_args['wasSubstituted'] ? "<p>(A default version has been substituted.)</p>" : "");
  }
  ...
  protected function _draw_toolbar_type_page_edit(){
    ...
    if ($this->_args['withCopy']) {
      $out.=
        ...
        ."<a class='ti' href=\".\" onclick=\"geid('submode').value='edit';geid('form').submit();return false;\">[ICON]18 18 279 Edit original page[/ICON]</a>\n"
        .($this->_args['allowPopupEdit']==1  ? "<a class='ti' href=\".\" onclick=\"details('pages','".$page_vars['ID']."','".$popup_arr['pages']['h']."','".$popup_arr['pages']['w']."');return false;\">[ICON]18 18 297 Edit original page in a popup window[/ICON]</a>\n" : "")
        .($this->_args['allowSaveAs']==1     ? "<a class='ti' href=\".\" onclick=\"geid('submode').value='save_as';geid('form').submit();return false;\">[ICON]16 16 315 Make another copy of the original page[/ICON]</a>\n" : "")
        .($this->_current_user_rights['isMASTERADMIN']==1   ?
            HTML::draw_toolbar_separator()
           ."<a class='ti' href=\".\" onclick=\"export_sql('pages',".$page_vars['ID'].");return false;\">[ICON]22 22 839 Export original page as SQL[/ICON]</a>\n"
         : "")
        .HTML::draw_toolbar_separator()
        .HTML::draw_toolbar_text("<b>Copy:</b>")."\n"
        ."<a class='ti' href=\".\" onclick=\"geid('submode').value='edit';geid('goto').value='".$this->_args['newPage']."';geid('form').submit();return false;\">[ICON]18 18 279 Edit copied page[/ICON]</a>\n"
        .($this->_args['allowPopupEdit']==1  ? "<a class='ti' href=\".\" onclick=\"details('pages','".$this->_args['newPageID']."','".$popup_arr['pages']['h']."','".$popup_arr['pages']['w']."');return false;\">[ICON]18 18 297 Edit copied page in a popup window[/ICON]</a>\n" : "")
         ;
    }
    else {
      ...
      $msg =
        ($usage['internal']==0 && $usage['system']==0 && $usage['page']<2 ?
            false
         :
            "WARNING:\\n\\nThis Layout is "
           .($usage['internal']>0 ? " an internal Layout" : "")
           .($usage['system']>0 ? ($usage['internal']>0 ? ", " : "")."defined by ".$usage['system']." Site".($usage['system']==1 ? "" : "s")." as ".($usage['system']==1 ? "its" : "their")." Default Layout" : "")
           .($usage['page']>0 ? ($usage['system']>0 || $usage['internal']>0 ? "\\nand " : "")."explicitly specified for use by ".$usage['page']." Page".($usage['page']==1 ? "" : "s") : "")
      ...
      $out.=
        ...
        .($this->_current_user_rights['isEDITOR'] && $this->_args['allowPopupEdit']==1  ?
             "<a class='ti' "
            ."href=\".\" onclick=\"details('".$this->_args['edit_params']['report']."','".$this->_args['ID']."','".$popup_arr['pages']['h']."','".$popup_arr['pages']['w']."');return false;\">"
        ...
        .($this->_current_user_rights['isAPPROVER'] && $this->_args['allowSaveAs']==1     ?
            HTML::draw_toolbar_separator()
           ."<a class='ti' href=\".\" onclick=\"geid('submode').value='save_as';geid('form').submit();return false;\">[ICON]16 16 315 Make a copy of this page[/ICON]</a>\n"
         : "")
        .($this->_current_user_rights['isEDITOR'] ?
           "<a class='ti' href=\".\" onclick=\"if(confirm('Delete this page?\\nThis change cannot be undone.')){geid('submode').value='delete_page';geid('form').submit();};return false;\">[ICON]16 16 3542 Delete this page[/ICON]</a>\n"
         : "")
        .($this->_current_user_rights['isEDITOR'] ?
            "<a class='ti' href=\".\" onclick=\"popup_page_create('".($layoutID!=$system_vars['defaultLayoutID'] ? $layoutID : 1)."','".$popup_arr['pages']['w']."','".$popup_arr['pages']['h']."');return false;\">[ICON]18 18 2090 Create a brand new page[/ICON]</a>\n"
         : "")
        .($this->_current_user_rights['isADMIN'] ? HTML::draw_toolbar_separator() : "")


          .($this->_current_user_rights['isMASTERADMIN'] && $componentID_post!=1 ?
             "<a class='ti' href=\".\" onclick=\"details('component',".$componentID_post.",'".$popup_arr['component']['h']."','".$popup_arr['component']['w']."');return false;\">"
            ."[ICON]17 17 1373 Edit embedded component[/ICON]</a>\n"
           : "")
          .($this->_current_user_rights['isADMIN'] && $allowEdit==1  ?
             "<a class='ti' href=\".\" onclick=\"".($msg ? "if (confirm('$msg')){" : "")."details('layouts','".$layoutID."','".$popup_arr['layouts']['h']."','".$popup_arr['layouts']['w']."');".($msg!='' ? "}" : "").";return false;\">[ICON]24 24 1273 Edit current Layout in a popup window[/ICON]</a>\n"
           : "")
          .($this->_current_user_rights['isMASTERADMIN'] || ($this->_current_user_rights['isADMIN'] && $Obj_System->has_feature('Themes')) ?
             "<a class='ti' href=\".\" onclick=\"details('theme',".$page_vars['themeID'].",'".$popup_arr['theme']['h']."','".$popup_arr['system']['w']."');return false;\">[ICON]18 18 2133 Edit current Theme in a popup window[/ICON]</a>\n"
           : "")
          .($this->_current_user_rights['isADMIN'] ?
             "<a class='ti' href=\".\" onclick=\"details('system',".SYS_ID.",'".$popup_arr['system']['h']."','".$popup_arr['system']['w']."');return false;\">[ICON]17 17 1331 Edit current Site Settings in a popup window[/ICON]</a>\n"
           : "")
          .($this->_current_user_rights['isAPPROVER'] ?
              HTML::draw_toolbar_separator()
             ."<a class='ti' href=\".\" onclick=\"popup_fileviewer();return false;\">[ICON]18 18 2552 Work with files on the server[/ICON]</a>\n"
           : "")
          .($this->_current_user_rights['isADMIN'] ? HTML::draw_toolbar_separator() : "")
          .($this->_current_user_rights['isMASTERADMIN'] ?
             "<a class='ti' href=\".\" onclick=\"export_sql('pages',".$page_vars['ID'].");return false;\">[ICON]22 22 839 Export this page as SQL[/ICON]</a>\n"
            .($componentID_post!=1 ?  "<a class='ti' href=\".\" onclick=\"export_sql('component',".$componentID_post.");return false;\">[ICON]23 23 816 Export embedded component[/ICON]</a>\n" : "")
            ."<a class='ti' href=\".\" onclick=\"export_sql('layouts',".$layoutID.");return false;\">[ICON]34 34 1297 Export current layout as SQL[/ICON]</a>\n"
            ."<a class='ti' href=\".\" onclick=\"export_sql('theme',".$page_vars['themeID'].");return false;\">[ICON]33 33 2163 Export current theme as SQL[/ICON]</a>\n"
           : ""
          )
          .($this->_current_user_rights['isADMIN'] ?
              "<a class='ti' href=\".\" onclick=\"export_sql('system',".SYS_ID.");return false;\">[ICON]25 25 1348 Export entire Site as SQL[/ICON]</a>\n"
           : ""
          )
          .($this->_current_user_rights['isEDITOR']==1 ?
             ...
             .($component_help ?
                "<a class='ti' "
               ."onmouseover=\"window.status='Click to hide Controls for components';return true;\" "
               ."onmouseout=\"window.status='';return true;\" "
               ."href=\".\" onclick=\"geid_set('component_help','0');geid('form').submit();return false;\""
               .">[ICON]18 18 1231 Hide Controls\nfor components[/ICON]</a>\n"
             :
                "<a class='ti' "
               ."onmouseover=\"window.status='Click to show Controls for components';return true;\" "
               ."onmouseout=\"window.status='';return true;\" "
               ."href=\".\" onclick=\"geid_set('component_help','1');geid('form').submit();return false;\""
  ...
  protected function _draw_toolbar_type_personal() {
    ...
    $out =
      ...
      .HTML::draw_toolbar_separator()
      .($this->_current_user_rights['isLOCKED']==0 ?
         "<a class='ti' href='".BASE_PATH."password'>[ICON]32 32 965 Change your Password[/ICON]</a>"
       :
         "<a class='ti' href=\".\" onclick=\"alert('You cannot change the password for this account');return false;\">[ICON]32 32 2959 Change your Password (Disabled)[/ICON]</a>"
       )
      .($this->_current_user_rights['isLOCKED']==0 ?
         "<a class='ti' href='".BASE_PATH."manage_profile'>[ICON]16 16 997 Manage your Profile[/ICON]</a>"
       :
         "<a class='ti' href=\".\" onclick=\"alert('You cannot administer the profile for this account');return false;\">[ICON]16 16 2991 Manage your Profile (Disabled)[/ICON]</a>"
       )
      .(System::has_feature('module-community') && $this->_current_user_rights['isCOMMUNITYADMIN'] ?
         "<a class='ti' href=\".\" onclick=\"popup_layer('Community Member Dashboard','community_member_dashboard',".Community_Member::dashboard_width.",".Community_Member::dashboard_height.");return false;\">[ICON]15 15 3558 Access your Community Member Dashboard[/ICON]</a>"
       : "")
      .(System::has_feature('Dashboard') && $this->_current_user_rights['isEDITOR'] ?
         ($this->_current_user_rights['isLOCKED']==0 ?
           "<a class='ti' href=\".\" onclick=\"popup_layer('Your Dashboard','dashboard',".Widget::$container_width.",".Widget::$container_height.");return false;\">[ICON]28 28 3027 View your Personal Dashboard[/ICON]</a>"
         :
           "<a class='ti' href=\".\" onclick=\"alert('You cannot access the Dashboard for this account');return false;\">[ICON]28 28 3055 View your Personal Dashboard (Disabled)[/ICON]</a>"
         )
       : ""
       )
      .(System::has_feature('Event-Registration') ?
          HTML::draw_toolbar_separator()
         .($this->_current_user_rights['isLOCKED']==0 ?
            "<a class='ti' href='".BASE_PATH."your_registered_events'>[ICON]20 20 124 See Events you are Registered for[/ICON]</a>"
           :
             "<a class='ti' href=\".\" onclick=\"alert('You cannot register for events using this account');return false;\">[ICON]20 20 3007 See Events you are Registered for (Disabled)[/ICON]</a>"
          )
       :
         ""
       )
      .(System::has_feature('E-Commerce') && $this->_current_user_rights['isLOCKED']==0 ?
         ...
         .(Cart::has_items() ?
            "<a class='ti' href='"
            .$checkout_page
            ."'>[ICON]14 14 1027 See items in your shopping cart[/ICON]</a>"
          :
            "<a class='ti' href='".BASE_PATH."checkout'>[ICON]14 14 1013 There are no items in your shopping cart[/ICON]</a>"
         )
         ."<a class='ti' href='".BASE_PATH."your_order_history'>[ICON]15 15 1041 See your Order History[/ICON]</a>"
       : "")
      .($system_vars['bugs_url']!='' ?
           HTML::draw_toolbar_separator()
      ...
      .HTML::draw_toolbar_separator()
      ."<a class='ti' href='".BASE_PATH."?command=signout'>[ICON]29 29 1056 Sign Out[/ICON]</a>\n"
      .HTML::draw_toolbar_separator()
      ."<a class='ti' href=\".\" onclick=\"popup_help('_help_user_toolbar');return false;\">[ICON]14 14 1085 Help[/ICON]</a>"
      .HTML::draw_toolbar_end();
    return
       "<div style='width:100%;'>"
      ...
      .(System::has_feature('Pending-Members') && !$this->_current_user_rights['isAPPROVED'] ? " <span style='color:red'>(Full Member access pending)</span>" : "")
      ."</div>\n"
  ...
  protected function _draw_toolbar_type_posting_edit(){
    ...
    $usage = $Obj_Layout->usage();
    $msg =
      ($usage['internal']==0 && $usage['system']==0 && $usage['page']==1 ?
          false
       :
    ...
    $out.=
      ...
      .($this->_current_user_rights['isEDITOR'] && $this->_args['allowPopupEdit']==1  ?
         "<a class='ti'"
        ." href=\"#\" onclick=\"details('".$this->_args['edit_params']['report']."','".$this->_args['ID']."','".$popup_arr['posting']['h']."','".$popup_arr['posting']['w']."');return false;\">"
        .$this->_args['edit_params']['icon_edit_popup']
        ."</a>\n"
       : ""
       )
      ...
      .($this->_current_user_rights['isADMIN'] && $allowEdit==1  ?
         ...
         .($msg ? "if (confirm('".$msg."')){" : "")."details('layouts','".$layoutID."','".$popup_arr['layout']['h']."','".$popup_arr['layout']['w']."');"
         .($msg!='' ? "}" : "").";return false;\">"
         ."[ICON]24 24 1273 Edit current Layout in a popup window[/ICON]"
         ."</a>\n"
       : "")
      .(isset($page_vars['block_layout']['systemID']) && ($this->_current_user_rights['isADMIN'] && $page_vars['block_layout']['systemID']==SYS_ID || $this->_current_user_rights['isMASTERADMIN']) ?
          "<a class='ti' href=\"#\" onclick=\"details('block_layout',".$page_vars['block_layout']['ID'].",'".$popup_arr['block_layout']['h']."','".$popup_arr['block_layout']['w']."');return false;\">"
       ...
       : "")
      .($this->_current_user_rights['isADMIN'] ?
          "<a class='ti' href=\"#\" onclick=\"details('theme',".$page_vars['themeID'].",'".$popup_arr['theme']['h']."','".$popup_arr['theme']['w']."');return false;\">"
         ."[ICON]17 17 2132 Edit current Theme in a popup window[/ICON]"
         ."</a>\n"
       : "")
      .($this->_current_user_rights['isADMIN'] ?
          "<a class='ti' href=\"#\" onclick=\"details('system',".SYS_ID.",'".$popup_arr['system']['h']."','".$popup_arr['system']['w']."');return false;\">"
  ...
  protected function _draw_toolbar_type_report(){
    ...
    $reportTitle =          $row['reportTitle'].($this->_args['report_name']=='system'? " in database <font color='#ff0000'>$db</font> (Codebase: ".CODEBASE_VERSION.")" : "");
    ...
    if (!(($canAdd) || ($canViewEmails) || ($canExportExcel && $this->_args['record_count']>0) || ($canAddToGroup && $this->_args['record_count']>0) || ($canEditReport))){
      return "";
    }
    if ($canEditReport) {
    ...
    $out =
       ($reportTitle!="" ?
         ...
         : "")
       .($this->_args['help']!="" ?
           "<a class='ti' href=\"".BASE_PATH.$this->_args['help']."\" onclick=\"popup_help('".$this->_args['help']."');return false;\">"
      ."<img src='".BASE_PATH."img/spacer' class='icons'"
      ...
      ." alt='?' /></a>"
       ...
       .($canExportExcel!==false ?
          "<a class='ti' "
         ."onmouseover=\"window.status='Export to Excel - apply filters or select individual records to customise your results';return true;\" "
         ."onmouseout=\"window.status='';return true;\" "
         ."href=\"#\" onclick=\"export_excel(".$this->_args['reportID'].");return false;\">"
         ."[ICON]16 16 1099 Export to Excel -\napply filters or select individual records\nto customise your results[/ICON]</a>\n"
       : "")
      .($canAddToGroup!==false ?
          "<a class='ti' "
         ."onmouseover=\"window.status='Add people to a group or adjust their membership permissions';return true;\" "
         ."onmouseout=\"window.status='';return true;\" "
         ."href=\"#\" onclick=\"add_to_group(".$this->_args['reportID'].",580,460);return false;\">"
    ...
    if ($canViewEmails!==false) {
      if ($submode!='show_addresses') {
        $out.=
            "<a class='ti' "
           ."onmouseover=\"window.status='View Email Addresses';return true;\" "
           ."onmouseout=\"window.status='';return true;\" "
           ."href=\"#\" onclick=\"return selected_view_email_addresses(1,'".$this->_args['reportID']."','".$report_name."','".$this->_args['toolbar']."','".$this->_args['ajax_mode']."');\">"
           ."[ICON]21 21 1131 View Email Addresses matching report filter or selection criteria[/ICON]</a>";
      }
      else {
        $out.=
            "<a class='ti' "
           ."onmouseover=\"window.status='Hide Email Addresses';return true;\" "
           ."onmouseout=\"window.status='';return true;\" "
           ."href=\"#\" onclick=\"return selected_view_email_addresses(0,'".$this->_args['reportID']."','".$report_name."','".$this->_args['toolbar']."','".$this->_args['ajax_mode']."');\">"
           ."[ICON]21 21 1152 Hide Email Addresses[/ICON]</a>";
      }
    }
    $out.=
       ($canAdd!==false ?
          "<a class='ti' "
         ."onmouseover=\"window.status='Add a new record';return true;\" "
         ."onmouseout=\"window.status='';return true;\" "
         ."href=\"#\" onclick=\""
         ."details('".$this->_args['report_name']."','','".$addPopupHeight."','".$addPopupWidth."',"
         .($this->_args['selectedReportID']!=0 ? $this->_args['selectedReportID'] : "''").","
         .($selectID!="" ? $selectID : "''").","
         ."0,"
         .($communityID!="" ? "'communityID=".$communityID."'" : "''")
         .");return false;\">"
         ."[ICON]33 33 917 Add...[/ICON]</a>"
       : "")
      ...
      .($canEditReport==1 ?
          "<a class='ti' "
         ."onmouseover=\"window.status='Edit this report';return true;\" "
         ."onmouseout=\"window.status='';return true;\" "
         ."href=\"#\" onclick=\"details('report','".$this->_args['reportID']."','".$reportPopup['h']."','".$reportPopup['w']."','".$this->_args['reportID']."');return false;\">"
         ."[ICON]15 15 1976 Edit this report[/ICON]</a>"
         ."<a class='ti' "
         ."onmouseover=\"window.status='Edit columns for this report';return true;\" "
         ."onmouseout=\"window.status='';return true;\" "
         ."href=\"./?mode=report&amp;report_name=report_columns_for_report&amp;selectID=".$this->_args['reportID']."\" "
         ."rel='external'>"
         ."[ICON]15 15 566 Show columns for this report[/ICON]</a>"
         ."<a class='ti' href=\"#\" "
         ."onmouseover=\"window.status='Copy this report with all columns';return true;\" "
         ."onmouseout=\"window.status='';return true;\" "
         ."onclick=\""
         ."var new_name=(prompt('Please enter new name','".$this->_args['report_name']."'));"
         ."if (new_name!=null) {"
         ."geid('targetValue').value=new_name;"
         ."geid('targetReportID').value='".$this->_args['reportID']."';"
         ."geid('submode').value='copy_report';"
         ."geid('form').submit();"
         ."}else{"
         ."alert('Report copy cancelled');"
         ."};return false;\">"
         ."[ICON]15 15 596 Copy this report and all columns[/ICON]</a>"
         ."<a class='ti' "
         ."onmouseover=\"window.status='Export this report as SQL';return true;\" "
         ."onmouseout=\"window.status='';return true;\" "
         ."href=\"#\" onclick=\"export_sql('report',".$this->_args['reportID'].");return false;\">"
         ."[ICON]20 20 611 Export this report as SQL[/ICON]</a>"
       : "")
       ;
  ...
  protected function _draw_toolbar_type_with_selected(){
    ...
    $content = $Obj_Report_Column->draw_selector_with_selected($this->_args['report_name'],$this->_args['reportID'],$this->_args['ajax_mode'],$this->_args['toolbar']);
    $html =
       "<span class='admin_toolbartable'>"
      .($this->_args['ajax_mode'] ? $content['html'] : $content)
      ."</span>";
    $html = HTML::draw_toolbar_frame($html,'left');
    return ($this->_args['ajax_mode'] ? array('html'=>$html,'js'=>$content['js'].";") : $html);
  }

  function draw_toolbar_end() {
    return
      "<div class='admin_toolbartable noprint'><img alt='|' class='toolbar_right' src='".BASE_PATH."img/color/404080'/></div>";
  }

  function draw_toolbar_frame($content='',$align='left') {
    return
  ...
  function draw_toolbar_text($text) {
    return
  ...
  function draw_toolbar_separator() {
    return
      "<div class='admin_toolbartable noprint'>"
