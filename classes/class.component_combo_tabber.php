<?php
define ("VERSION_COMPONENT_COMBO_TABBER","1.0.8");
/*
Version History:
  1.0.8 (2014-04-26)
...
class Component_Combo_Tabber extends Component_Base {
  ...
  function __construct(){
    ...
    $this->_parameter_spec =   array(
      'box' =>                                  array('match' => 'enum|0,1',  							'default'=>'1',           'hint'=>'0|1'),
      'box_rss_link' =>                         array('match' => 'enum|0,1',  							'default'=>'1',           'hint'=>'0|1'),
      'box_shadow' =>                           array('match' => 'enum|0,1',  							'default'=>'0',           'hint'=>'0|1'),
      'box_width' =>                            array('match' => '',									'default'=>'200',         'hint'=>'0..x'),
      'calendar_small.filter_category_list' =>  array('match' => '',									'default'=>'*',           'hint'=>'CSV Category List for Events'),
      'calendar_small.filter_memberID' =>       array('match' => 'ID',						            'default'=>'',            'hint'=>'ID of Community Member to restrict by that criteria - or zero to exclude all member content'),
      'calendar_small.show' =>                  array('match' => 'enum|0,1',  							'default'=>'1',           'hint'=>'0|1'),
      'list_events.box_footer' =>               array('match' => '',									'default'=>'',            'hint'=>'Footer for Events'),
      'list_events.box_header' =>               array('match' => '',									'default'=>'',            'hint'=>'Header for Events'),
      'list_events.box_title' =>                array('match' => '',									'default'=>'Events',      'hint'=>'Title for Events'),
      'list_events.filter_category_list' =>     array('match' => '',									'default'=>'*',           'hint'=>'CSV Category List for Events'),
      'list_events.filter_memberID' =>          array('match' => 'ID',									'default'=>'',            'hint'=>'ID of Community Member to restrict by that criteria - or zero to exclude all member content'),
      'list_events.filter_what' =>              array('match' => 'enum|all,future,month,past',			'default'=>'month',       'hint'=>'all|future|month|past'),
      'list_events.results_limit' =>            array('match' => '',									'default'=>'5',           'hint'=>'0..n Max Events to show'),
      'list_events.show' =>                     array('match' => 'enum|0,1',  							'default'=>'1',           'hint'=>'0|1'),
      'list_news.box_footer' =>                 array('match' => '',									'default'=>'',            'hint'=>'Footer for News'),
      'list_news.box_header' =>                 array('match' => '',									'default'=>'',            'hint'=>'Header for News'),
      'list_news.box_title' =>                  array('match' => '',									'default'=>'News',        'hint'=>'Title for News'),
      'list_news.filter_category_list' =>       array('match' => '',									'default'=>'*',           'hint'=>'CSV Category List for News'),
      'list_news.filter_memberID' =>            array('match' => 'ID',									'default'=>'',            'hint'=>'ID of Community Member to restrict by that criteria - or zero to exclude all member content'),
      'list_news.results_limit' =>              array('match' => '',									'default'=>'5',           'hint'=>'0..n Max News Items to show'),
      'list_news.show' =>                       array('match' => 'enum|0,1',  							'default'=>'1',           'hint'=>'0|1'),
      'list_podcasts.audioplayer_height' =>     array('match' => '',									'default'=>'24',          'hint'=>'0..n'),
      'list_podcasts.audioplayer_width' =>      array('match' => '',									'default'=>'180',         'hint'=>'0..n'),
      'list_podcasts.box_header' =>             array('match' => '',									'default'=>'',            'hint'=>'Header for Podcasts'),
      'list_podcasts.box_footer' =>             array('match' => '',									'default'=>'',            'hint'=>'Footer for Podcasts'),
      'list_podcasts.box_header' =>             array('match' => '',									'default'=>'',            'hint'=>'Header for Podcasts'),
      'list_podcasts.box_title' =>              array('match' => '',									'default'=>'Audio',       'hint'=>'Title for Podcasts'),
      'list_podcasts.filter_category_list' =>   array('match' => '',									'default'=>'*',           'hint'=>'CSV Category List for Podcasts'),
      'list_podcasts.filter_memberID' =>        array('match' => 'ID',									'default'=>'',            'hint'=>'ID of Community Member to restrict by that criteria - or zero to exclude all member content'),
      'list_podcasts.results_limit' =>          array('match' => '',									'default'=>'5',           'hint'=>'0..n Max Podcasts to show'),
      'list_podcasts.show' =>                   array('match' => 'enum|0,1',  							'default'=>'1',           'hint'=>'0|1'),
      'section_tab_order' =>                    array('match' => '',									'default'=>'events,news,podcasts',           'hint'=>'CSV List of tabs to determine displayed order'),
    );
  }
  ...
  protected function _draw_podcasts(){
    ...
    $args =
      array(
        ...
        'box_rss_link' =>           $this->_cp['box_rss_link'],
        'box_title' =>              "Latest ".($this->_cp['list_podcasts.box_title']=='Sermons' && $this->_cp['list_podcasts.results_limit']==1 ? 'Sermon' : $this->_cp['list_podcasts.box_title']),
        'box_width' =>              $this->_cp['box_width'],
  ...
  protected function _draw_section_tabs(){
    ...
    Page::push_content(
      'javascript_onload',
      "  $('#section_".$this->_selected_section."').parent().height($('#section_".$this->_selected_section."').height());\n"
    );
  }
