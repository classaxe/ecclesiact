...
class Context_Menu extends Base
{
    ...
    private function _cm_article()
    {
        ...
        $this->register_js(
            ...
            ."CM_label('".$CM."5',(_CM.important ? 'Yes' : 'No')+"
            ."'<div style=\'float:right\'>(Click to change)<\/div>');\n"
            ."CM_label('".$CM."6',(_CM.shared ?    'Yes' : 'No')+"
            ."'<div style=\'float:right\'>(Click to change)<\/div>');\n"
            ...
            $this->draw_cm_context(
                ...
                $this->draw_cm_actions(
                    $this->draw_cm_action(
                        ...
                        .$this->popup_size_arr[$reports[0]]['h'].","
                        .$this->popup_size_arr[$reports[0]]['w'].","
                        ."'','');",
                        true
                    )
                    .$this->draw_cm_action(
            ...
            .$this->draw_cm_context(
                ...
                $this->draw_cm_actions(
                    $this->draw_cm_action(
                        ...
                        ."'".$reports[2]."',"
                        ."'',"
                        .$this->popup_size_arr[$reports[2]]['h'].","
                        .$this->popup_size_arr[$reports[2]]['w'].","
                        ."'',"
                        ."'',"
                        ."0,"
                        ."'memberID='+_CM.ID+"
                        ."'&communityID='+_CM.communityID+"
                        ."'&map_location='+_CM.map_location+"
                        ."'&location='+_CM.map_description"
                        .");"
                    )
                    .$this->draw_cm_action(
                        'l',
                        '',
                        'New Event - Christmas category',
                        '',
                        '',
                        "CM_CloseContext();"
                        ."void details("
            ...
            $this->draw_cm_context(
                ...
                $this->draw_cm_actions(
                    ...
                    .$this->draw_cm_action(
                        'm',
                        '',
                        '<img src="'.BASE_PATH.'img/spacer" class="icon" style="float:none;display:inline;width:8px;height:10px;background-position:-5389px 0" alt="Rotate Left" /> Rotate Left',
                        '',
                        '',
                    ...
                    .$this->draw_cm_action(
                        'm',
                        '',
                        '<img src="'.BASE_PATH.'img/spacer" class="icon" style="float:none;display:inline;width:8px;height:10px;background-position:-5397px 0" alt="Rotate Right" /> Rotate Right',
                        '',
                        '',
            ...
            $this->draw_cm_context(
                ...
                $this->draw_cm_actions(
                    $this->draw_cm_action(
                        'm',
                        '',
                        "Edit Accent <span id='".$CM."1'></span> for",
                        's',
                        $CM.'2',
            ...
            $this->draw_cm_context(
                ...
                $this->draw_cm_actions(
                    ...
                    .$this->draw_cm_action(
                        ...
                        '<img src="'.BASE_PATH.'img/spacer" class="icon" style="float:none;display:inline;width:8px;height:10px;background-position:-5389px 0" alt="Rotate Left" /> Rotate Left',
                        'm',
                        'CM_gallery_image_rotate_left_text',
                        "CM_CloseContext();geid_set('source',_CM['source']);geid_set('submode','gallery_image_rotate_left');geid_set('targetID',_CM.ID);geid('form').submit();"
                    )
                    .$this->draw_cm_action(
                        'm',
                        ...
                        '<img src="'.BASE_PATH.'img/spacer" class="icon" style="float:none;display:inline;width:8px;height:10px;background-position:-5397px 0" alt="Rotate Right" /> Rotate Right',
                        'm',
                        'CM_gallery_image_rotate_right_text',
                        "CM_CloseContext();geid_set('source',_CM['source']);geid_set('submode','gallery_image_rotate_right');geid_set('targetID',_CM.ID);geid('form').submit();"
                    )
                    .$this->draw_cm_action(
                        'l',
