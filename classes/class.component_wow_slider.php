<?php
define ("VERSION_COMPONENT_WOW_SLIDER","1.0.7");
/*
Version History:
  1.0.7 (2014-01-28)
...
class Component_WOW_Slider extends Component_Base {
  ...
  public function __construct(){
    ...
    $fx =           "basic,basic_linear,blast,blinds,blur,fade,flip,fly,kenburns,rotate,slices,squares,stack,stack_vertical";
    $this->_parameter_spec =    array(
      'bullets_show' =>             array('match' => 'enum|0,1',        'default' =>'1',            'hint'=>'0|1'),
      'bullets_margin_top' =>       array('match' => 'range|0,n',       'default' =>'0',            'hint'=>'Give a value to alter distance of bullets from top of frame'),
      'caption_show' =>             array('match' => 'enum|0,1',        'default' =>'1',            'hint'=>'0|1'),
      'content_background' =>       array('match' => '',                'default' =>'000000',       'hint'=>'Background colour for caption'),
      'content_color' =>            array('match' => '',                'default' =>'ffffff',       'hint'=>'Text colour for caption'),
      'content_opacity' =>          array('match' => 'range|0,100',     'default' =>'80',           'hint'=>'Opacity in % for caption area'),
      'controls_show' =>            array('match' => 'enum|0,1',        'default' =>'1',            'hint'=>'0|1'),
      'effect' =>                   array('match' => 'enum|'.$fx,       'default' =>'fade',         'hint'=>str_replace(',','|',$fx)),
      'effect_reverse' =>           array('match' => 'enum|0,1',        'default' =>'0',            'hint'=>'0|1'),
      ...
      'hide_if_path_extended' =>    array('match' => 'enum|0,1',        'default' =>'0',            'hint'=>'If set, then the slider will not show when the path is extended'),
...
//      'onchange' =>                 array('match' => '',                'default' =>'',             'hint'=>'javascript to execute when an image changes'),
      'random_order' =>             array('match' => 'enum|0,1',        'default' =>'0',            'hint'=>'0|1 - Whether to start with first image or play from a random position'),
      ...
      'secCaption' =>               array('match' => 'range|0,n',	    'default'=>'0.5',           'hint'=>'Decimal time in seconds for fade'),
      'secFade' =>                  array('match' => 'range|0,n',	    'default'=>'1',             'hint'=>'Decimal time in seconds for fade'),
      'secShow' =>                  array('match' => 'range|0,n',	    'default'=>'4',             'hint'=>'Decimal time in seconds for show'),
      ...
      'thumbnail_maintain_aspect' =>array('match' => 'enum|0,1',        'default' =>'1',           'hint'=>'Maximum height in pixels'),
      'thumbnail_height' =>         array('match' => 'range|1,n',       'default' =>'19',           'hint'=>'Maximum height in pixels'),
      'thumbnail_width' =>          array('match' => 'range|1,n',       'default' =>'80',           'hint'=>'Maximum width in pixels'),
...
//      y($image);die;
      $Obj_GI->load($image);
      $this->_html.=
         "    <li>".($image['url'] ? "<a href=\"".$image['url']."\"".($image['url_popup'] ? " rel='external'" : '').">" : "")
  ...
  protected function _draw_js(){
    ...
    Page::push_content(
      ...
      ."    next:             '',\n"
      ."    onBeforeStep:     ".($this->_cp['random_order']=='1' ? "function(curIdx,count){return(curIdx+1 + Math.floor((count-1)*Math.random()));}" : "0").",\n"
      ."    prev:             '',\n"
