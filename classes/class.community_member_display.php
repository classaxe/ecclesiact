<?php
define('COMMUNITY_MEMBER_DISPLAY_VERSION','1.0.37');
/*
Custom Fields used:
...
class Community_Member_Display extends Community_Member {
  ...
  protected function _draw_css(){
    ...
    $css =
       ".profile_frame .member_slideshow                { width: ".(($this->_cp['profile_photo_width'])+20)."px; }\n"
      .".profile_frame .photo_frame .member_photo_frame { width: ".(($this->_cp['profile_photo_width']))."px; height:".(($this->_cp['profile_photo_height']))."px; }\n"
  ...
  protected function _draw_about(){
    ...
    $this->_html.=
      ...
      .($this->_pageID ?
       ...
       :
          "<b>Error </b>: The 'About' section template page //".trim($this->_cp['template_member_page'],'/')."/ wasn't found."
       )
      ."<div class='clear'>&nbsp;</div>"
  ...
  protected function _draw_about_items($content){
    $replace = array(
      ...
      '[[MEMBER_URL]]' =>           BASE_PATH.trim($this->_community_record['URL'],'/').'/'.trim($this->_record['name'],'/'),
  ...
  protected function _draw_calendar(){
    if (!$this->_cp['show_calendar'] || !($this->_record['full_member'] || $this->_record['primary_ministerialID'])){
      return;
    }
  ...
  protected function _draw_community_navigation(){
    ...
    $this->_html.=
      ...
      ."<img src='".BASE_PATH."img/icon/2600/11' style='vertical-align:middle;margin-right: 2px;' alt='Member Profile'/>"
      ."Use these controls to navigate around community."
      ."<div class='profile_nav'>\n"
      ."<input type=\"button\" class=\"form_button\" style=\"width:5em;text-align:left\" title=\"View ".$this->_nav_prev['title']."\" value=\"&lt; Prev\""
      ." onclick=\"document.location='".BASE_PATH.trim($page_vars['relative_URL'],'/')."/".$this->_nav_prev['name']."'+document.location.hash\" />\n"
      ."<input type=\"button\" class=\"form_button\" style=\"width:5em;\" title=\"View entire ".$this->_Obj_Community->record['title']." community\" value=\"Up\""
      ." onclick=\"document.location='".BASE_PATH.trim($page_vars['relative_URL'],'/')."'\" />\n"
      ."<input type=\"button\" class=\"form_button\" style=\"width:5em;text-align:right\" title=\"View ".$this->_nav_next['title']."\" value=\"Next &gt;\""
      ." onclick=\"document.location='".BASE_PATH.trim($page_vars['relative_URL'],'/')."/".$this->_nav_next['name']."'+document.location.hash\" />\n"
      ."</div>"
      ."</div>\n";
  }
  ...
  protected function _draw_contact_form_draw_form(){
    $this->_html.=
      ...
      .draw_form_field('contact_send_to',$this->contact_send_to,'selector_csvlist',400,'','','','','','',$this->_contacts_csv)
      ."<br class='clr_b' />"
      .Report_Column::draw_label('Your Name:','','contact_sender_name',200)
      .draw_form_field('contact_sender_name',$this->contact_sender_name,'text',400,'',''," onkeypress=\"return keytest_enter_execute(event,function(){geid('contact_sender_email').focus();})\"")
      ."<br class='clr_b' />"
      .Report_Column::draw_label('Your Email:','','contact_sender_email',200)
      .draw_form_field('contact_sender_email',$this->contact_sender_email,'text',400,'',''," onkeypress=\"return keytest_enter_execute(event,function(){geid('contact_message').focus();})\"")
      ."<br class='clr_b' />"
      .Report_Column::draw_label('Your Message:','','contact_message',200)
      .draw_form_field('contact_message',$this->contact_message,'textarea',400,'','','','','','','',150)
      ."<br class='clr_b' />"
      .Report_Column::draw_label('Verification Image:','','captcha_key',200)
      ."<img class='formField std_control' style='border:1px solid #7F9DB9;padding:2px;' src='".BASE_PATH."?command=captcha_img' alt='Verification Image' />"
      ."<br class='clr_b' />"
      .Report_Column::draw_label('Verification Code:','','captcha_key',200)
      .draw_form_field('captcha_key','','text',182,'',''," onkeypress=\"keytest_enter_execute(event,function(){geid('contact_form_send').focus();})\"")
      ."<br class='clr_b' />"
      ."<p class='txt_c'>\n"
      ."  <input type='button' id='contact_form_send' value='Send Message' onclick='return contact_form_verify();'/>\n"
      ."</p>\n"
      ."</div>";
  }
  ...
  protected function _draw_contact_form_draw_js(){
    $js =
      ...
      ."  var err_arr = [];\n"
      ."  var n = 1;\n"
      ."  if (geid_val(\"contact_send_to\")=='0') { err_arr.push((n++)+\") Message To\"); }\n"
      ."  if (geid_val(\"contact_sender_name\")=='') { err_arr.push((n++)+\") Your Name\"); }\n"
      ."  if (!email_check(geid_val(\"contact_sender_email\"))) { err_arr.push((n++)+\") Your Email\"); }\n"
      ."  if (geid_val(\"contact_message\")=='') { err_arr.push((n++)+\") Your Message\"); }\n"
      ."  if (geid_val(\"captcha_key\").length!=6) { err_arr.push((n++)+\") Characters shown in the image (slows down spammers!)\"); }\n"
  ...
  protected function _draw_contact_form_draw_result(){
    $this->_html.=
      ...
      ."<div class='clr_b'></div>"
       ."<p class='txt_c'><input type='button' value='Done' onclick=\"document.location='".BASE_PATH.trim($this->_community_record['URL'],'/').'/'.trim($this->_record['name'],'/')."#contact'\" /></p>\n"
      ."</div>";
  }
    ...
    switch ($this->submode){
      case "community_member_contact":
        ...
        if (!$Obj_Captcha->isKeyRight(isset($_POST['captcha_key']) ? $_POST['captcha_key'] : "NOWAY")) {
          $this->_msg =	    "<span style='color:red'><b>Error</b>: You must enter the same characters shown in the image.</span>";
          break;
        }
        ...
        $data =
          array(
            ...
            'subject' =>          "Contact via Web Site",
            'html' =>             $this->contact_message,
  ...
  protected function _draw_contact_form_setup(){
    ...
    if ($personID = get_userID()){
      ...
      $Obj_User->load();
      $this->contact_sender_email = ($this->contact_sender_email ? $this->contact_sender_email : $Obj_User->record['PEmail']);
      $this->contact_sender_name =  ($this->contact_sender_name ?  $this->contact_sender_name :
  ...
  protected function _draw_map(){
    ...
    $Obj_Map->map_centre($this->_record['service_map_lat'],$this->_record['service_map_lon'],$this->_cp['profile_map_zoom']);
    $img =
    ...
    $marker_html =
      ...
      ."<br />".$this->_record['service_addr_city'].' &bull; '.$this->_record['service_addr_sp'].' &bull; '.$this->_record['service_addr_postal'];
  ...
  protected function _draw_members(){
    ...
    $img =
      ...
      $this->_html.=
        ...
        .">\n"
        ."    <a href=\"".$r['member_URL']."\">"
        ."<img alt=\"".str_replace('& ','&amp; ',$r['title'])."\" src=\"".$featured_image."\" style=\"border:1px solid #888; float:left;margin:0 1em 0 0\"/></a>"
  ...
  protected function _draw_events(){
    if (!$this->_cp['show_events'] || !($this->_record['full_member'] || $this->_record['primary_ministerialID'])){
      return;
    }
  ...
  protected function _draw_news(){
    if (!$this->_cp['show_news'] || !($this->_record['full_member'] || $this->_record['primary_ministerialID'])){
      return;
    }
  ...
  protected function _draw_podcasts(){
    ...
    $this->_html.=
      ...
      ."<h2>Latest ".($this->_record['type']=='ministerium' ? 'Audio' : 'Sermons')." from ".htmlentities($this->_record['title'])."</h2>\n"
  ...
  protected function _draw_profile(){
    ...
    $website =      (isset($r['link_website']) && $r['link_website'] ? substr($r['link_website'],2+strpos($r['link_website'],'//')) : "");
    $facebook =     (isset($r['link_facebook']) && $r['link_facebook'] ? substr($r['link_facebook'],2+strpos($r['link_facebook'],'//')) : "");
    $twitter =      (strpos($r['link_twitter'],'@')!==-1 ? substr($r['link_twitter'],1+strpos($r['link_twitter'],'@')) : "");
    ...
    if ($r['link_video']){
      ...
      if (count($url_bits)>2){
        switch ($url_bits[2]){
          case 'livestream.com':    case 'www.livestream.com':    case 'new.livestream.com':
            $video_icon =   "-7950px 0px";
            $video_label =  "Livestream";
          break;
          case 'ustream.tv':    case 'www.ustream.tv':
    ...
    $this->_html.=
      ...
      ."<div class='inner'>"
      ."<h2>"
      .($this->_current_user_rights['isEditor'] ? "<a href=\"".BASE_PATH."details/".$this->_edit_form['member']."/".$r['ID']."\" onclick=\"details('".$this->_edit_form['member']."',".$r['ID'].",".$this->_popup['member']['h'].",".$this->_popup['member']['w'].",'','');return false;\">" : "")
      ."Profile for ".$r['title']
      ...
      .($r['full_member'] || $verified || $ministerial ?
          ...
          .($r['full_member']?
                 "<img src='".BASE_PATH."img/spacer' width='32' height='32' class='icons-big' style='background-position: -15692px 0px;' alt='Premium Listing - all features available' title='Premium Listing - all features available'/>"
              : ""
           )
          .($verified ?
              "<img src='".BASE_PATH."img/spacer' width='32' height='32' class='icons-big' style='background-position: -15996px 0px;' title=\"Verified by ".$r['type']." on ".format_date($verified,'l j F Y')."\" alt=\"Member Verified\" />"
            : ""
           )
          .($ministerial ?
              "<img src='".BASE_PATH."img/spacer' width='32' height='32' class='icons-big' style='background-position: -16030px 0px;' title=\"Member of ".$ministerial."\" alt=\"Member of ".$ministerial."\" />"
            : ""
           )
          ."</div>"
        :
      ...
      .($r['date_survey_returned']!='0000-00-00' ? "<h3>Information Verified by Member:</h3><p style='margin:0 0 2em 1em;'>".format_date($r['date_survey_returned'])."</p>" : "")
      .($r['ministerial_title'] ?
           "<h3>Member of:</h3>\n"
          ."<p style='margin:0 0 2em 1em;'>"
          ."<a href=\"".BASE_PATH.trim($this->_community_record['URL'],'/').'/'.trim($r['ministerial_name'],'/')."\" rel=\"external\">"
          .$r['ministerial_title']
          ."</a></p>"
        :
           ""
      ...
      .($r['languages'] ?"<h3>Languages for Services:</h3><p style='margin:0 0 2em 1em;'>".$languages."</p>" : "")
      .($r['service_notes'] ? "<h3>Notes:</h3><p style='margin:0 0 2em 1em;'>\n".$r['service_notes']."</p>" : "")
      ."</div>\n"
      ."<div class='clear'>&nbsp;</div>\n"
      .($servicetimes ?
      ...
      .($r['link_website'] ?
          "<div class='label'><img class='icon' src='/img/spacer' alt='' title='' style='width:16px;height:16px;margin:0px 5px 2px 0px;background-position:-800px 0px;float:left;' />Web Site:</div>\n"
      ...
      .($r['link_facebook']?
          "<div class='label'><img class='icon' src='/img/spacer' alt='' title='' style='width:14px;height:14px;margin:0px 5px 2px 0px;background-position:-3147px 0px;float:left;' />Facebook:</div>\n"
         ."<div class='value'><a rel=\"external\" href=\""
         .$r['link_facebook']."\">"
         .$facebook
         ."</a></div>"
      ...
      .($r['link_twitter']?
          "<div class='label'><img class='icon' src='/img/spacer' alt='' title='' style='width:14px;height:14px;margin:2px 5px 2px 0px;background-position:-5420px 0px;float:left;' />Twitter:</div>\n"
         ."<div class='value'><a rel=\"external\" href=\""
         .$r['link_twitter']."\">"
         .$twitter
         ."</a></div>"
      ...
      .($r['link_video']?
          "<div class='label'><img class='icon' src='/img/spacer' alt='' title='' style='width:16px;height:16px;margin:0px 5px 2px 0px;float:left;background-position:".$video_icon."' />".$video_label.":</div>\n"
         ."<div class='value'><a rel=\"external\" href=\""
         .$r['link_video']."\">"
         .$video
         ."</a></div>"
      ...
      .($r['full_member'] || $r['primary_ministerialID'] ?
         "<div class='label'>"
        ."<img class='icon' src='/img/spacer' alt='' title='' style='width:16px;height:16px;margin:0px 5px 2px 0px;background-position:-8047px 0px;float:left;' /> RSS:</div>"
        ."<div class='value'>["
        .($r['full_member'] ? " <a rel=\"external\" href=\"".$this->_base_path."/rss/articles\">Articles</a> |\n" : "")
        ." <a rel=\"external\" href=\"".$this->_base_path."/rss/events\">Events</a> |\n"
        ." <a rel=\"external\" href=\"".$this->_base_path."/rss/news\">News</a>\n"
        .($r['full_member'] ? "| <a rel=\"external\" href=\"".$this->_base_path."/rss/podcasts\">Sermons</a>\n" : "")
        ."]"
        ."</div>"
       :
         ""
      ...
      .($r['full_member'] ?
         "<div class='label'><img class='icon' src='/img/spacer' alt='' title='' style='width:16px;height:16px;margin:0px 5px 4px 0px;background-position:-6170px 0px;float:left;' /> Share:</div> "
        ."<div class='value'><a href=\"#\" onclick=\"return community_embed('".addslashes(htmlentities($r['title']))."','".$this->_base_path."')\">Show live updates on your website...</a></div>\n"
       :
         ""
       )
      ."</div>\n"
  ...
  protected function _draw_service_times(){
    ...
    foreach($days as $day){
      if (isset($this->_record['service_times_'.strToLower(substr($day,0,3))]) && trim($this->_record['service_times_'.strToLower(substr($day,0,3))])){
        ...
        for($i=0; $i<count($entries); $i++){
          ...
          if (trim($entry)!=''){
            ...
            $out.=
               "  <tr>\n"
              .($i==0 ? "    <th class='s_day'".($rowspan>1 ? " rowspan='".$rowspan."'" : "").">".$day."</th>\n" : '')
    ...
    return
       "<table class='service_details' cellpadding='2' cellspacing='0' border='1' summary='Table showing meeting times'>"
      ."  <thead>\n"
      ."    <tr>\n"
      ."      <th>Day</th>\n"
      ."      <th>Time</th>\n"
  ...
  protected function _draw_stats(){
    ...
    $this->_html.=
      ...
      ."<table cellpadding='2' cellspacing='0' border='1' class='member_stats' summary='Table showing statistics for this member'>\n"
      ."  <thead>\n"
      ."    <tr>\n"
      ."      <th rowspan='3' class='st_date st_line st_bord_l st_bord_t'>Month</th>\n"
      ."      <th colspan='4' class='st_comm st_line st_bord_t'>Community of ".$this->_community_record['title']."</th>\n"
      ."      <th colspan='4' class='st_prof st_line st_bord_t'>".$r['title']." Profile</th>\n"
      ."      <th colspan='8' class='st_link st_bord_t st_bord_r'>Link referrals for<br />\n".$r['title']."</th>\n"
      ."    </tr>\n"
      ."    <tr>\n"
      ...
      ."      <th rowspan='2' class='st_link".($r['link_website']   ? '' : " st_void")."'>Website</th>\n"
      ."      <th rowspan='2' class='st_link".($r['link_facebook']  ? '' : " st_void")."'>Facebook</th>\n"
      ."      <th rowspan='2' class='st_link".($r['link_twitter']   ? '' : " st_void")."'>Twitter</th>\n"
      ."      <th rowspan='2' class='st_link st_bord_r".($r['link_video']     ? '' : " st_void")."'>Video</th>\n"
      ."    </tr>\n"
      ."    <tr>\n"
...
//      y($links);die;
      $this->_html.=
        ...
        ."      <td class='st_comm".$bord_b."'>".$comm['hits']."</td>\n"
        ."      <td class='st_comm".$bord_b."'>".$comm['visits']."</td>\n"
        ."      <td class='st_comm".$bord_b."'>".($comm['time_a'] ? format_seconds($comm['time_a']) : "&nbsp;")."</td>\n"
        ."      <td class='st_comm st_line".$bord_b."'>".($comm['time_t'] ? format_seconds($comm['time_t']) : "&nbsp;")."</td>\n"
        ."      <td class='st_prof".$bord_b."'>".$prof['hits']."</td>\n"
        ."      <td class='st_prof".$bord_b."'>".$prof['visits']."</td>\n"
        ."      <td class='st_prof".$bord_b."'>".($prof['time_a'] ? format_seconds($prof['time_a']) : "&nbsp;")."</td>\n"
        ."      <td class='st_prof st_line".$bord_b."'>".($prof['time_t'] ? format_seconds($prof['time_t']) : "&nbsp;")."</td>\n"
        ."      <td class='st_link".$bord_b."'>".($r['link_website']  && $link[$r['link_website']]['hits'] ?    $link[$r['link_website']]['hits'] :    "&nbsp;")."</td>\n"
        ."      <td class='st_link".$bord_b."'>".($r['link_facebook'] && $link[$r['link_facebook']]['hits'] ?   $link[$r['link_facebook']]['hits'] :   "&nbsp;")."</td>\n"
        ."      <td class='st_link".$bord_b."'>".($r['link_twitter']  && $link[$r['link_twitter']]['hits'] ?    $link[$r['link_twitter']]['hits'] :    "&nbsp;")."</td>\n"
        ."      <td class='st_link st_bord_r".$bord_b."'>".($r['link_video']    && $link[$r['link_video']]['hits'] ?      $link[$r['link_video']]['hits'] :      "&nbsp;")."</td>\n"
        ."    </tr>\n";
    }
    $this->_html.=
       "  </tbody>\n"
  ...
  protected function _draw_title(){
    $this->_html.=
      ...
      .": "
      ."<a href=\"".BASE_PATH.trim($this->_community_record['URL'],'/').'/'.trim($this->_record['name'],'/')."\">"
  ...
  protected function _draw_web_share($rss='', $embed=''){
    return
      ...
      .($rss ?
         ...
         ."<a rel=\"external\" title=\"Click to subscribe to this RSS Feed\" href=\"".$this->_base_path."/rss/".$rss."\">RSS</a>\n"
       :
          ""
       )
      .($embed ?
          "<img class='icon share' src='/img/spacer' alt='' title='Embed on your website'  />"
         ."<a title=\"Embed this information on your website\" href=\"#\" onclick=\"return community_embed('".addslashes(htmlentities($this->_record['title']))."','".$this->_base_path."','".$embed."')\">Web</a>\n"
       :
          ""
       )
      ."</div>";
  ...
  protected function _setup_load_user_rights(){
    ...
    $this->_current_user_rights['canViewStats'] =   $this->_current_user_rights['canEdit'];
  }
  ...
  protected function _setup_tabs(){
    ...
    if ($this->_cp['show_map']==1 && ($this->_record['service_map_lat']!=0 || $this->_record['service_map_lon']!=0)){
    ...
    if ($this->_cp['show_articles']==1 &&   ($this->_record['full_member'])){
      $this->_section_tabs_arr[] =   array('ID'=>'articles','label'=>$this->_cp['tab_articles']);
    }
    if ($this->_cp['show_events']==1 &&     ($this->_record['full_member'] || $this->_record['primary_ministerialID'])){
      $this->_section_tabs_arr[] =   array('ID'=>'events','label'=>$this->_cp['tab_events']);
    }
    if ($this->_cp['show_calendar']==1 &&   ($this->_record['full_member'] || $this->_record['primary_ministerialID'])){
      $this->_section_tabs_arr[] =   array('ID'=>'calendar','label'=>$this->_cp['tab_calendar']);
    }
    if ($this->_cp['show_news']==1 &&       ($this->_record['full_member'] || $this->_record['primary_ministerialID'])){
      $this->_section_tabs_arr[] =   array('ID'=>'news','label'=>$this->_cp['tab_news']);
    }
    if ($this->_cp['show_podcasts']==1 &&   ($this->_record['full_member'])){
      $this->_section_tabs_arr[] =   array('ID'=>'podcasts','label'=>($this->_record['type'] == 'church' ? $this->_cp['tab_podcasts'] : $this->_cp['tab_audio']));
    }
