...
class Custom_Form extends Record
{
    ...
    public $_ObjXML;
    public $_current_user_rights =           array();
    public static $valid_prefix = "vp_";
    public static $js_arr = array();
    public static $html_arr = array();
    public static $dtd = "<!DOCTYPE form [
...
";
  // Functions prefixed frm produce parts for forms
    ...
    public function draw($xml_doc, $cp)
    {
    ...
    public function draw_fees_overview($width = 150)
    {
        global          $system_vars;
        ...
        return
            ...
            ."    <div class='fl txt_r' style='width:".$lbl_width."px;'>"
            ."<span id='div_surcharge_name'>Payment Method</span>"
            ." Surcharge at <span id='div_surcharge_percent'>0</span>%"
            ."</div>\n"
            ."    <div class='fl txt_r' style='width:15px;'>".$system_vars['defaultCurrencySymbol']."</div>"
            ."    <div class='fr txt_r' style='width:55px;'>"
            ...
            ."    <div class='fl txt_r' style='width:".$lbl_width."px;'>"
            ."<b>Total Cost (".$system_vars['defaultCurrencySuffix'].")</b>"
            ."</div>\n"
            ."    <div class='fl txt_r' style='width:15px'>".$system_vars['defaultCurrencySymbol']."</div>"
            ."    <div class='fr txt_r' style='width:55px;'>"
    ...
    public function draw_js_loadTotalCost()
    {
        return
             "// ************************************\n"
            ...
            ."  var preferred = (arguments[0] ?\n"
            ."    arguments[0]\n"
            ."  :\n"
            ."    (geid('billing_address_selector') ?\n"
            ."      geid_val('billing_address_selector').toUpperCase()\n"
            ."    :\n"
            ."      geid_val('TBillingAddress').toUpperCase()\n"
            ."    )\n"
            ."  );\n"
            ."  switch (preferred){\n"
            ."    case 'H':\n"
            ...
            ."        sub_tax = customform_get_tax_costs(\n"
            ."          product,\n"
            ."          tax_regime_arr,\n"
            ."          tax_regime_tax_columns_used,\n"
            ."          BCountryID,\n"
            ."          BSpID\n"
            ."        );\n"
            ...
            ."    var surcharge_percent = (payment_method_arr[geid_val('TMethod')] ?\n"
            ."      payment_method_arr[geid_val('TMethod')].surcharge\n"
            ."    :\n"
            ."      0\n"
            ."    );\n"
    ...
    public function draw_js_tax_regimes($taxRegimeID_csv)
    {
        if (!$taxRegimeID_csv) {
            return
             "// Tax Regimes:\n"
    ...
    public function frm_row_content($content, $bgcolor = '', $id = '', $hidden = false)
    {
        return
         "  <tr valign='top'"
        .($id!="" ? " id=\"".$id."\"" : "")
    ...
    public function frm_row_head($text)
    {
        return
    ...
    public function frm_row_head_sub($text)
    {
        return
         "  <tr valign='top' class='formHead'>\n"
    ...
    public function frm_row_label($label, $bgcolor = "")
    {
        return
    ...
    public function frm_row_label_content(
        $label,
        $content,
        $bgcolor = '',
        $content_width = '',
        ...
        return
            ...
            .($bgcolor!="" || $hidden ?
             ...
             : "")
              ...
              ."    <td colspan='2' class='formFieldContent'"
              .($content_width ? " style='width:".(50+$content_width)."px'" : "").">"
              .$content
              ."</td>\n"
              ."  </tr>\n";
    }

    public function frm_row_label_cost_content($label, $cost, $content, $bgcolor = "")
    {
        return
             "  <tr valign='top'".($bgcolor!="" ? " style=\"background-color:".$bgcolor."\"" : "").">\n"
    ...
    public function frm_row_label_req_content(
        $label,
        $req,
        $content,
        $bgcolor = '',
        ...
        return
             "  <tr valign='top'".($bgcolor!="" ? " style=\"background-color:".$bgcolor."\"" : "").">\n"
            ."    <td class='formFieldMargin formFieldLabel'"
            .($label_width ? " style='width:".$label_width.";'" : "")
            .">".$label."</td>\n"
    ...
    public function frm_row_spacer($height = 5)
    {
        return
             "  <tr valign='top'>\n"
            ."    <td colspan='3'>"
            ."<img src='".BASE_PATH."img/spacer' height='".$height."' width='1' alt='' class='b' />"
            ."</td>\n"
            ."  </tr>\n";
    }

    public function frm_table_close()
    {
        return "</table>\n";
    }

    public function frm_table_open($ID = '', $width = '', $hidden = false)
    {
        return
    ...
    public function get_ID_by_name($name, $systemID = "", $no_cache = false, $just_form = true)
    {
    ...
    public function get_valid_name($name)
    {
        return (is_numeric(substr($name, 0, 1)) ? $this->get_valid_prefix().$name : $name);
    }

    public function get_valid_prefix()
    {
    ...
    {
        return parent::manageActionsForNamedReport('actions_for_custom_form');
    }

    public function push_html($code)
    {
        Custom_Form::$html_arr[] = $code;
    }

    public function push_js($code)
    {
        Custom_Form::$js_arr[] = $code;
    }

    public function set_billing_address(
        $use,
        &$BAddress1,
        &$BAddress2,
        &$BCity,
    ...
    public function set_tax_apply(
        ...
        switch ($system_vars['tax1_name']) {
            case "GST":
                $tax1_apply = $apply_GST;
                break;
            case "HST":
                $tax1_apply = $apply_HST;
                break;
            case "QST":
                $tax1_apply = $apply_QST;
                break;
            default:
                $tax1_apply = false;
                break;
        ...
        switch ($system_vars['tax2_name']) {
            case "GST":
                $tax2_apply = $apply_GST;
                break;
            case "HST":
                $tax2_apply = $apply_HST;
                break;
            case "QST":
                $tax2_apply = $apply_QST;
                break;
            default:
                $tax2_apply = false;
                break;
        ...
        switch ($system_vars['tax3_name']) {
            case "GST":
                $tax3_apply = $apply_GST;
                break;
            case "HST":
                $tax3_apply = $apply_HST;
                break;
            case "QST":
                $tax3_apply = $apply_QST;
                break;
            default:
                $tax3_apply = false;
                break;
        ...
        switch ($system_vars['tax4_name']) {
            case "GST":
                $tax4_apply = $apply_GST;
                break;
            case "HST":
                $tax4_apply = $apply_HST;
                break;
            case "QST":
                $tax4_apply = $apply_QST;
                break;
            default:
                $tax4_apply = false;
                break;
    ...
    public function xml_form_prepare($args = array())
    {
        ...
        $this->xml_form_prepare_get_products();
        $this->xml_form_prepare_js();
        $out = "<div class=\"custom_form\" id=\"cf\" style=\"display:none\">\n";
        $number_style =
            (isset($this->_ObjXML['number_style']) ? $this->_ObjXML['number_style'] : false);
        $default_field_width =
            (isset($this->_ObjXML['default_field_width']) ?      $this->_ObjXML['default_field_width'] : 300);
        $default_section_width =
            (isset($this->_ObjXML['default_section_width']) ?    $this->_ObjXML['default_section_width'] : 600);
        $isMASTERADMIN =  get_person_permission("MASTERADMIN");
        $isSYSADMIN =         get_person_permission("SYSADMIN");
        $isSYSAPPROVER =  get_person_permission("SYSAPPROVER");
        $canProxy = ($isMASTERADMIN || $isSYSADMIN || $isSYSAPPROVER);
                        ...
                        switch ($_type) {
                            case 'combo_sp_selector':
                                $_field_obj = draw_form_field(
                                    ...
                                    '',
                                    0,
                                    "onchange=\"combo_selector_set('".$_name."','".((int)$_width)."px');".$_js."\"",
                                    0,
                                    0,
                                    '',
                                    'lst_sp'
                            ...
                            case 'fees_shipping':
                                ...
                                $this->push_js(
                                    ...
                                    ."  if (geid(\"total_ship_error\") && geid_val(\"total_ship_error\")==1) {\n"
                                    ."    err_arr[err_arr.length] = (n++)+\") Problem with shipping address\"\n"
                                    ."  }\n"
                                );
                                break;
                            case 'selector_payment_method':
...
//  print "draw_form_field($_name,$_value,$_type,$_width,'','',$_js.$_maxlength,$_readonly,'','',$_params,$_height);";
                                break;
                        }
                        switch ($_type) {
                            case "hidden":
                                ...
                                switch ($_type) {
                                    case "selector_payment_method":
                                        $this->push_js(
                                            ...
                                            ."  var hascost = parseFloat(geid_val('total_cost'));\n"
                                            ."  if (hascost && geid_val(\"".$_name."\")=='') {\n"
                                            ."    err_arr[err_arr.length] = (n++)+\") ".$err_label."\"\n"
                                            ."  } else {\n"
                                            ."    err_arr = checkout_validate_payment_details(err_arr);\n"
                                            ."  }\n"
                                        );
                                        break;
                                    case "selector_billing_address":
                                          $this->push_js(
                                              "\n  // For Billing Address Selector validation\n"
                                              ...
                                              ."      if (geid_val(prefix+'Address1')=='') {\n"
                                              ."        err_arr[err_arr.length] = (n++)+') '+name+' Address';\n"
                                              ."      };\n"
                                              ."      if (geid_val(prefix+'City')=='')     {\n"
                                              ."        err_arr[err_arr.length] = (n++)+') '+name+' City';\n"
                                              ."      };\n"
                                              ."      if (geid_val(prefix+'SpID')=='')     {\n"
                                              ."        err_arr[err_arr.length] = (n++)+') '+name+' State / Prov';\n"
                                              ."      };\n"
                                              ."      if (geid_val(prefix+'Postal')=='')   {\n"
                                              ."        err_arr[err_arr.length] = (n++)+') '+name+' Postal Code';\n"
                                              ."      };\n"
                                              ."      if (geid_val(prefix+'CountryID')==''){\n"
                                              ."        err_arr[err_arr.length] = (n++)+') '+name+' Country'\n"
                                              ."      };\n"
                                              ."      break;\n"
                                              ."  }\n"
                                          );
    ...
    protected function xml_form_prepare_js()
    {
        $this->push_js(
        ...
        if (count($this->_products)>0) {
            // JS for tax regime
            $this->push_js(
                "startupFunctions.push("
                ."function(){"
                ."  customform_draw_fees_overview(tax_regime_taxes_used,currency_symbol);"
                ."}"
                .");\n"
            );
            $this->push_js($this->xml_form_prepare_get_product_tax_regimes_js()."\n");
    ...
    protected function xml_form_prepare_get_product_tax_regimes_js()
    {
        $taxRegimes_csv = $this->xml_form_prepare_get_product_tax_regimes();
        return $this->draw_js_tax_regimes($taxRegimes_csv);
    }

    protected function xml_form_prepare_get_products()
    {
        $out = array();
        foreach ($this->_ObjXML->section as $section) {
            foreach ($section->row as $row) {
    ...
    protected function xml_form_prepare_get_product_tax_regimes()
    {
    ...
    public function xml_form_fields()
    {
        $out = array();
    ...
    public function xml_form_get_field_list($field, &$out)
    {
    //    y($field);
            ...
            if (!$readonly) {
                switch ($table_name) {
                    ...
                    default:
                        ...
                        switch ($type) {
                            case 'combo_sp_selector':
                                $out[$table_name][$field_name] =
                                    (isset($_REQUEST[(string)$field['name']]) ? $_REQUEST[(string)$field['name']] : '');
                                break;
                            case "file_upload":
    ...
    public function xml_form_process()
    {
        global $page_vars;
        ...
        } elseif (array_key_exists('order', $tables)) { // only view order if there is an order involved
    ...
    public function xml_form_process_order($order_data, $item_data, $canProxy)
    {
    ...
    // create order
        ...
        if ($item_data) {
            do_log(
                ...
                'Setup-3',
                "Preparing to add ordered items to order #".$orderID
            );
            foreach ($item_data as $productID => $qty) {
                ...
                do_log(
                    ...
                    __CLASS__."::".__FUNCTION__."()",
                    'Setup-3a',
                    "  Getting tax rates for ".$qty." x ".$productID." (".$record['itemCode'].") in order #".$orderID
                );
                $data = array(
                ...
                do_log(
                    ...
                    __CLASS__."::".__FUNCTION__."()",
                    'Setup-3d',
                    "    Added order item ".$orderItemID." to order #".$orderID
                );
                $sourceID =       $productID;
                $sourceType =     'product';
                ...
                do_log(
                    ...
                    __CLASS__."::".__FUNCTION__."()",
                    'Setup-3e',
                    "    About to execute product_order actions for ordered item ".$orderItemID." in order #".$orderID
                );
                $ObjAction->execute(
                    $sourceType,
                    $sourceID,
                ...
                do_log(
                    ...
                    __CLASS__."::".__FUNCTION__."()",
                    'Setup-3f',
                    "    Executed product_order actions for ordered item ".$orderItemID." in order #".$orderID
                );
            }
        }
        do_log(
            ...
            __CLASS__."::".__FUNCTION__."()",
            'Setup-4',
            "Setting costs for order ".$orderID
        );
        $Obj_Order->set_costs();
        do_log(
            0,
            __CLASS__."::".__FUNCTION__."()",
            'Payment-1',
            "Order #".$orderID." payment method: ".$_REQUEST['TMethod']
        );
        $Obj_PM = new Payment_Method;
        if ($Obj_PM->method_is_offline(get_var('TMethod'))) {
              do_log(
                  ...
                  __CLASS__."::".__FUNCTION__."()",
                  'Payment-2',
                  "  Order #".$orderID." to be processed by offline-payment method ".$_REQUEST['TMethod']
              );
            ...
            do_log(
                ...
                __CLASS__."::".__FUNCTION__."()",
                'Payment-2',
                "  Order #".$orderID." to be processed by online-payment method ".$_REQUEST['TMethod']
            );
            $Obj_Order->payment(
                isset($_REQUEST['TCardNumber']) ? $_REQUEST['TCardNumber'] : "",
        ...
        if ($processed) {
            ...
            do_log(
                ...
                __CLASS__."::".__FUNCTION__."()",
                'Payment-3',
                "  Order #".$orderID." failed to process - $gateway_result"
            );
        }
        return $orderID;
    }

    public function xml_form_process_person($data, $canProxy)
    {
        if (!$data) {
            return false;
        }
    ...
    public function xml_form_reset($xmlstr)
    {
