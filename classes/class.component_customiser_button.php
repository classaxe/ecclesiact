<?php
define ("VERSION_COMPONENT_CUSTOMISER_BUTTON","1.0.0");
/*
Version History:
  1.0.0 (2014-11-15)
...
class Component_Customiser_Button extends Component_Base {
  ...
  public function __construct(){
    ...
    $this->_parameter_spec =    array(
      ...
      'presets' =>      array('default'=>'',                                    'hint'=>'Preset sequences that have been defined'),
      'disable' =>      array('default'=>'0',                                   'hint'=>'0|1'),
      'targets' =>      array('default'=>'body|1|0,h1|0|1,h2|0|1',              'hint'=>'CSV list of css targets each with pipe-delimited parameters 0 or 1 for background-color and color palette tools'),
      'title' =>        array('default'=>'Site Customiser',                     'hint'=>'Title for icon and for dialog'),
    );
  }
  ...
  protected function _draw(){
    ...
    if (Person::get_permission("SYSADMIN") && !$this->_cp['disable']) {
      ...
      Page::push_content(
        ...
        .".customiser input.spectrum { display: block; float: left; width:5em; height: 14px; line-height:14px; padding: 0px; font-family: courier-new, monospace; font-size:8pt; }\n"
      );
