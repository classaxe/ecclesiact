...
params.addCss='@import url(http://fonts.googleapis.com/css?family=Open+Sans+Condensed:300);';

if (!parseInt(params.noFrame)){
	// frame border+shadow
	var border = { 'top': 18, 'right': 15, 'bottom': 20, 'left': 15 };
	...
	params.backMarginsBottom_bul = border.bottom/4;
