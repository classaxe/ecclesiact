...
params.addCss='@import url(http://fonts.googleapis.com/css?family=Open+Sans+Condensed:300&subset=latin,latin-ext,cyrillic);';
...
if (params.Thumbnails){
	...
	params.thumbFullWidth  = 4*2+6+parseInt(params.ThumbWidth );
	params.thumbFullHeight = 4*2+6+parseInt(params.ThumbHeight);
}
